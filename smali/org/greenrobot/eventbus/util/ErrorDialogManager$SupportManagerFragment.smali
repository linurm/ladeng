...
.method public static attachTo(Landroid/app/Activity;Ljava/lang/Object;ZLandroid/os/Bundle;)V
    ...
    invoke-virtual {v1}, Landroid/support/v4/app/ah;->a()Landroid/support/v4/app/au;

    move-result-object v2

    const-string v3, "de.greenrobot.eventbus.error_dialog_manager"

    invoke-virtual {v2, v0, v3}, Landroid/support/v4/app/au;->a(Landroid/support/v4/app/Fragment;Ljava/lang/String;)Landroid/support/v4/app/au;

    move-result-object v2

    invoke-virtual {v2}, Landroid/support/v4/app/au;->a()I

    invoke-virtual {v1}, Landroid/support/v4/app/ah;->b()Z
...
.method public onEventMainThread(Lorg/greenrobot/eventbus/util/ThrowableFailureEvent;)V
    ...
    invoke-virtual {p0}, Lorg/greenrobot/eventbus/util/ErrorDialogManager$SupportManagerFragment;->getFragmentManager()Landroid/support/v4/app/ah;
    ...
    invoke-virtual {v0}, Landroid/support/v4/app/w;->dismiss()V
