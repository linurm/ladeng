...
.method public enqueue(Lorg/greenrobot/eventbus/Subscription;Ljava/lang/Object;)V
    ...
    iget-boolean v0, p0, Lorg/greenrobot/eventbus/BackgroundPoster;->executorRunning:Z
    ...
    iget-object v0, p0, Lorg/greenrobot/eventbus/BackgroundPoster;->eventBus:Lorg/greenrobot/eventbus/EventBus;
...
.method public run()V
    ...
    :goto_0
    :try_start_0
    iget-object v0, p0, Lorg/greenrobot/eventbus/BackgroundPoster;->queue:Lorg/greenrobot/eventbus/PendingPostQueue;

    const/16 v1, 0x3e8

    invoke-virtual {v0, v1}, Lorg/greenrobot/eventbus/PendingPostQueue;->poll(I)Lorg/greenrobot/eventbus/PendingPost;
    ...
    iput-boolean v4, p0, Lorg/greenrobot/eventbus/BackgroundPoster;->executorRunning:Z
