...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/firebase/iid/FirebaseInstanceIdInternalReceiver;->a:Ljava/util/Queue;

    new-instance v0, Ljava/util/LinkedList;

    invoke-direct {v0}, Ljava/util/LinkedList;-><init>()V

    sput-object v0, Lcom/google/firebase/iid/FirebaseInstanceIdInternalReceiver;->b:Ljava/util/Queue;
...
.method static a(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;)I
    .locals 4
    ...
    invoke-static {p0, v0}, Lcom/google/firebase/iid/FirebaseInstanceIdInternalReceiver;->c(Landroid/content/Context;Landroid/content/Intent;)I
    ...
    :pswitch_1
    sget-object v0, Lcom/google/firebase/iid/FirebaseInstanceIdInternalReceiver;->b:Ljava/util/Queue;
...
.method public static b(Landroid/content/Context;Landroid/content/Intent;)Landroid/content/Intent;
    ...
    invoke-static {p0, v0, p1}, Lcom/google/firebase/iid/FirebaseInstanceIdInternalReceiver;->b(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;)Landroid/content/Intent;
...
.method private static c(Landroid/content/Context;Landroid/content/Intent;)I
    .locals 3

    invoke-static {p0, p1}, Lcom/google/firebase/iid/FirebaseInstanceIdInternalReceiver;->d(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-static {p0, p1}, Lcom/google/firebase/iid/FirebaseInstanceIdInternalReceiver;->a(Landroid/content/Context;Landroid/content/Intent;)Landroid/content/ComponentName;
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-static {p1, v1, v0}, Lcom/google/firebase/iid/FirebaseInstanceIdInternalReceiver;->a(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;)I
