...
.field private final e:Landroid/support/v4/widget/v;
...
.field private final k:Landroid/support/v4/widget/cm;

.field private final l:Landroid/support/v4/widget/cm;

.field private final m:Landroid/support/v4/widget/ac;

.field private final n:Landroid/support/v4/widget/ac;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/widget/DrawerLayout;->a:Landroid/support/v4/widget/w;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v0, p0}, Landroid/support/v4/widget/v;-><init>(Landroid/support/v4/widget/DrawerLayout;)V

    iput-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->e:Landroid/support/v4/widget/v;
    ...
    new-instance v2, Landroid/support/v4/widget/ac;

    invoke-direct {v2, p0, v3}, Landroid/support/v4/widget/ac;-><init>(Landroid/support/v4/widget/DrawerLayout;I)V

    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->m:Landroid/support/v4/widget/ac;
    ...
    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->n:Landroid/support/v4/widget/ac;

    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->m:Landroid/support/v4/widget/ac;

    invoke-static {p0, v5, v2}, Landroid/support/v4/widget/cm;->a(Landroid/view/ViewGroup;FLandroid/support/v4/widget/cp;)Landroid/support/v4/widget/cm;

    move-result-object v2

    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/cm;

    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/cm;

    invoke-virtual {v2, v4}, Landroid/support/v4/widget/cm;->a(I)V

    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/cm;

    invoke-virtual {v2, v1}, Landroid/support/v4/widget/cm;->a(F)V

    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->m:Landroid/support/v4/widget/ac;

    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/cm;

    invoke-virtual {v2, v3}, Landroid/support/v4/widget/ac;->a(Landroid/support/v4/widget/cm;)V

    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->n:Landroid/support/v4/widget/ac;

    invoke-static {p0, v5, v2}, Landroid/support/v4/widget/cm;->a(Landroid/view/ViewGroup;FLandroid/support/v4/widget/cp;)Landroid/support/v4/widget/cm;

    move-result-object v2

    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/cm;

    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/cm;

    const/4 v3, 0x2

    invoke-virtual {v2, v3}, Landroid/support/v4/widget/cm;->a(I)V

    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/cm;

    invoke-virtual {v2, v1}, Landroid/support/v4/widget/cm;->a(F)V

    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->n:Landroid/support/v4/widget/ac;

    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/cm;

    invoke-virtual {v1, v2}, Landroid/support/v4/widget/ac;->a(Landroid/support/v4/widget/cm;)V

    invoke-virtual {p0, v4}, Landroid/support/v4/widget/DrawerLayout;->setFocusableInTouchMode(Z)V

    invoke-static {p0, v4}, Landroid/support/v4/view/bw;->c(Landroid/view/View;I)V

    new-instance v1, Landroid/support/v4/widget/u;

    invoke-direct {v1, p0}, Landroid/support/v4/widget/u;-><init>(Landroid/support/v4/widget/DrawerLayout;)V

    invoke-static {p0, v1}, Landroid/support/v4/view/bw;->a(Landroid/view/View;Landroid/support/v4/view/a;)V

    const/4 v1, 0x0

    invoke-static {p0, v1}, Landroid/support/v4/view/de;->a(Landroid/view/ViewGroup;Z)V

    invoke-static {p0}, Landroid/support/v4/view/bw;->w(Landroid/view/View;)Z

    move-result v1

    if-eqz v1, :cond_0

    sget-object v1, Landroid/support/v4/widget/DrawerLayout;->a:Landroid/support/v4/widget/w;

    invoke-interface {v1, p0}, Landroid/support/v4/widget/w;->a(Landroid/view/View;)V

    sget-object v1, Landroid/support/v4/widget/DrawerLayout;->a:Landroid/support/v4/widget/w;

    invoke-interface {v1, p1}, Landroid/support/v4/widget/w;->a(Landroid/content/Context;)Landroid/graphics/drawable/Drawable;
...
.method private a(Landroid/view/View;Z)V
    ...
    invoke-static {v2, v3}, Landroid/support/v4/view/bw;->c(Landroid/view/View;I)V
...
.method private i()Z
    ...
    invoke-static {v0}, Landroid/support/v4/widget/aa;->c(Landroid/support/v4/widget/aa;)Z
...
.method public a(Landroid/view/View;)I
    ...
    iget v0, v0, Landroid/support/v4/widget/aa;->a:I
...
.method a()Landroid/view/View;
    ...
    invoke-static {v0}, Landroid/support/v4/widget/aa;->b(Landroid/support/v4/widget/aa;)I
...
.method public a(II)V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/cm;

    :goto_1
    invoke-virtual {v0}, Landroid/support/v4/widget/cm;->e()V
    ...
    :cond_2
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/cm;
...
.method a(IILandroid/view/View;)V
    ...
    invoke-virtual {v2}, Landroid/support/v4/widget/cm;->a()I

    move-result v2

    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/cm;

    invoke-virtual {v3}, Landroid/support/v4/widget/cm;->a()I
    ...
    invoke-static {v0}, Landroid/support/v4/widget/aa;->a(Landroid/support/v4/widget/aa;)F
    ...
    invoke-interface {v0, v2}, Landroid/support/v4/widget/z;->a(I)V
...
.method public a(Landroid/support/v4/widget/z;)V
    .locals 1
...
.method a(Landroid/view/View;F)V
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v4/widget/z;->a(Landroid/view/View;F)V
...
.method a(Z)V
    ...
    iget-object v7, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/cm;
    ...
    invoke-virtual {v7, v5, v6, v8}, Landroid/support/v4/widget/cm;->a(Landroid/view/View;II)Z
    ...
    :goto_2
    invoke-static {v0, v3}, Landroid/support/v4/widget/aa;->a(Landroid/support/v4/widget/aa;Z)Z

    goto :goto_1

    :cond_2
    iget-object v6, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/cm;
    ...
    invoke-virtual {v6, v5, v7, v8}, Landroid/support/v4/widget/cm;->a(Landroid/view/View;II)Z
    ...
    :cond_3
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->m:Landroid/support/v4/widget/ac;

    invoke-virtual {v0}, Landroid/support/v4/widget/ac;->a()V

    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->n:Landroid/support/v4/widget/ac;
...
.method public addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->e:Landroid/support/v4/widget/v;
...
.method public b(Landroid/support/v4/widget/z;)V
    .locals 1
...
.method b(Landroid/view/View;)V
    ...
    invoke-static {v0, v3}, Landroid/support/v4/widget/aa;->a(Landroid/support/v4/widget/aa;I)I
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/widget/z;->b(Landroid/view/View;)V
...
.method b(Landroid/view/View;F)V
    ...
    :cond_0
    invoke-static {v0, p2}, Landroid/support/v4/widget/aa;->a(Landroid/support/v4/widget/aa;F)F
...
.method c(Landroid/view/View;)V
    ...
    invoke-static {v0, v2}, Landroid/support/v4/widget/aa;->a(Landroid/support/v4/widget/aa;I)I
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/widget/z;->a(Landroid/view/View;)V
...
.method public computeScroll()V
    ...
    invoke-virtual {v0, v4}, Landroid/support/v4/widget/cm;->a(Z)Z

    move-result v0

    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/cm;

    invoke-virtual {v1, v4}, Landroid/support/v4/widget/cm;->a(Z)Z
...
.method protected drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    invoke-virtual {v2}, Landroid/support/v4/widget/cm;->b()I
    ...
    invoke-virtual {v3}, Landroid/support/v4/widget/cm;->b()I
...
.method g(Landroid/view/View;)Z
    ...
    invoke-static {p1}, Landroid/support/v4/view/bw;->h(Landroid/view/View;)I
...
.method protected generateDefaultLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, v1, v1}, Landroid/support/v4/widget/aa;-><init>(II)V
...
.method public generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, v1, p1}, Landroid/support/v4/widget/aa;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method protected generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, p1}, Landroid/support/v4/widget/aa;-><init>(Landroid/support/v4/widget/aa;)V
    ...
    invoke-direct {v0, p1}, Landroid/support/v4/widget/aa;-><init>(Landroid/view/ViewGroup$MarginLayoutParams;)V
    ...
    invoke-direct {v0, p1}, Landroid/support/v4/widget/aa;-><init>(Landroid/view/ViewGroup$LayoutParams;)V
...
.method public h(Landroid/view/View;)V
    ...
    invoke-static {v0, v1}, Landroid/support/v4/widget/aa;->b(Landroid/support/v4/widget/aa;I)I
    ...
    invoke-virtual {v0, p1, v1, v2}, Landroid/support/v4/widget/cm;->a(Landroid/view/View;II)Z
...
.method public i(Landroid/view/View;)V
    ...
    invoke-static {v0, v1}, Landroid/support/v4/widget/aa;->a(Landroid/support/v4/widget/aa;I)I
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    sget-object v0, Landroid/support/v4/widget/DrawerLayout;->a:Landroid/support/v4/widget/w;

    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->G:Ljava/lang/Object;

    invoke-interface {v0, v1}, Landroid/support/v4/widget/w;->a(Ljava/lang/Object;)I
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v3, p1}, Landroid/support/v4/widget/cm;->a(Landroid/view/MotionEvent;)Z

    move-result v3

    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/cm;

    invoke-virtual {v4, p1}, Landroid/support/v4/widget/cm;->a(Landroid/view/MotionEvent;)Z
    ...
    iget-object v5, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/cm;

    float-to-int v0, v0

    float-to-int v4, v4

    invoke-virtual {v5, v0, v4}, Landroid/support/v4/widget/cm;->d(II)Landroid/view/View;
    ...
    invoke-virtual {v0, v4}, Landroid/support/v4/widget/cm;->d(I)Z
...
.method protected onLayout(ZIIII)V
    ...
    iget v1, v0, Landroid/support/v4/widget/aa;->leftMargin:I

    iget v2, v0, Landroid/support/v4/widget/aa;->topMargin:I

    iget v3, v0, Landroid/support/v4/widget/aa;->leftMargin:I
    ...
    iget v0, v0, Landroid/support/v4/widget/aa;->topMargin:I
    ...
    :goto_3
    iget v4, v0, Landroid/support/v4/widget/aa;->a:I

    and-int/lit8 v4, v4, 0x70

    sparse-switch v4, :sswitch_data_0

    iget v4, v0, Landroid/support/v4/widget/aa;->topMargin:I

    add-int/2addr v9, v2

    iget v11, v0, Landroid/support/v4/widget/aa;->topMargin:I
    ...
    iget v10, v0, Landroid/support/v4/widget/aa;->bottomMargin:I
    ...
    iget v11, v0, Landroid/support/v4/widget/aa;->bottomMargin:I
    ...
    iget v12, v0, Landroid/support/v4/widget/aa;->topMargin:I
    ...
    iget v13, v0, Landroid/support/v4/widget/aa;->bottomMargin:I

    sub-int v13, v11, v13

    if-le v12, v13, :cond_6

    iget v4, v0, Landroid/support/v4/widget/aa;->bottomMargin:I
...
.method protected onMeasure(II)V
    ...
    iget v6, v0, Landroid/support/v4/widget/aa;->a:I

    invoke-static {v6, v8}, Landroid/support/v4/view/q;->a(II)I

    move-result v6

    invoke-static {v10}, Landroid/support/v4/view/bw;->w(Landroid/view/View;)Z

    move-result v11

    if-eqz v11, :cond_8

    sget-object v11, Landroid/support/v4/widget/DrawerLayout;->a:Landroid/support/v4/widget/w;

    iget-object v12, p0, Landroid/support/v4/widget/DrawerLayout;->G:Ljava/lang/Object;

    invoke-interface {v11, v10, v12, v6}, Landroid/support/v4/widget/w;->a(Landroid/view/View;Ljava/lang/Object;I)V
    ...
    iget v6, v0, Landroid/support/v4/widget/aa;->leftMargin:I

    sub-int v6, v2, v6

    iget v11, v0, Landroid/support/v4/widget/aa;->rightMargin:I
    ...
    iget v0, v0, Landroid/support/v4/widget/aa;->bottomMargin:I
    ...
    invoke-interface {v11, v0, v12, v6}, Landroid/support/v4/widget/w;->a(Landroid/view/ViewGroup$MarginLayoutParams;Ljava/lang/Object;I)V
    ...
    invoke-static {v10}, Landroid/support/v4/view/bw;->t(Landroid/view/View;)F
    ...
    invoke-static {v10, v6}, Landroid/support/v4/view/bw;->f(Landroid/view/View;F)V
    ...
    iget v11, v0, Landroid/support/v4/widget/aa;->leftMargin:I
    ...
    iget v11, v0, Landroid/support/v4/widget/aa;->width:I
    ...
    iget v12, v0, Landroid/support/v4/widget/aa;->bottomMargin:I

    add-int/2addr v11, v12

    iget v0, v0, Landroid/support/v4/widget/aa;->height:I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/widget/cm;->b(Landroid/view/MotionEvent;)V
    ...
    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/cm;

    float-to-int v5, v0

    float-to-int v6, v3

    invoke-virtual {v4, v5, v6}, Landroid/support/v4/widget/cm;->d(II)Landroid/view/View;
    ...
    invoke-virtual {v4}, Landroid/support/v4/widget/cm;->d()I
...
.method public setDrawerElevation(F)V
    ...
    invoke-static {v1, v2}, Landroid/support/v4/view/bw;->f(Landroid/view/View;F)V
...
.method public setDrawerListener(Landroid/support/v4/widget/z;)V
    .locals 1
    .annotation runtime Ljava/lang/Deprecated;
    .end annotation

    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->x:Landroid/support/v4/widget/z;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->x:Landroid/support/v4/widget/z;

    invoke-virtual {p0, v0}, Landroid/support/v4/widget/DrawerLayout;->b(Landroid/support/v4/widget/z;)V

    :cond_0
    if-eqz p1, :cond_1

    invoke-virtual {p0, p1}, Landroid/support/v4/widget/DrawerLayout;->a(Landroid/support/v4/widget/z;)V

    :cond_1
    iput-object p1, p0, Landroid/support/v4/widget/DrawerLayout;->x:Landroid/support/v4/widget/z;
