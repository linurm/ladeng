...
# static fields
.field private static final v:Landroid/support/v4/widget/ax;

.field private static final w:[I


# instance fields
.field private A:Landroid/support/v4/widget/ay;

.field private a:J

.field private final b:Landroid/graphics/Rect;

.field private c:Landroid/support/v4/widget/bm;

.field private d:Landroid/support/v4/widget/ah;
...
.method private a()V
    ...
    invoke-static {v0, v1}, Landroid/support/v4/widget/bm;->a(Landroid/content/Context;Landroid/view/animation/Interpolator;)Landroid/support/v4/widget/bm;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->c:Landroid/support/v4/widget/bm;
...
.method private f()V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->d:Landroid/support/v4/widget/ah;
    ...
    iget-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->e:Landroid/support/v4/widget/ah;
...
.method private g()V
    ...
    iput-object v1, p0, Landroid/support/v4/widget/NestedScrollView;->d:Landroid/support/v4/widget/ah;

    new-instance v1, Landroid/support/v4/widget/ah;

    invoke-direct {v1, v0}, Landroid/support/v4/widget/ah;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, Landroid/support/v4/widget/NestedScrollView;->e:Landroid/support/v4/widget/ah;
    ...
    :cond_1
    iput-object v2, p0, Landroid/support/v4/widget/NestedScrollView;->d:Landroid/support/v4/widget/ah;

    iput-object v2, p0, Landroid/support/v4/widget/NestedScrollView;->e:Landroid/support/v4/widget/ah;
...
.method public final a(II)V
    ...
    iget-object v2, p0, Landroid/support/v4/widget/NestedScrollView;->c:Landroid/support/v4/widget/bm;

    invoke-virtual {p0}, Landroid/support/v4/widget/NestedScrollView;->getScrollX()I

    move-result v3

    invoke-virtual {v2, v3, v1, v4, v0}, Landroid/support/v4/widget/bm;->a(IIII)V
    ...
    :cond_1
    iget-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->c:Landroid/support/v4/widget/bm;

    invoke-virtual {v0}, Landroid/support/v4/widget/bm;->a()Z
...
.method a(IIIIIIIIZ)Z
    ...
    iget-object v1, p0, Landroid/support/v4/widget/NestedScrollView;->c:Landroid/support/v4/widget/bm;
    ...
    invoke-virtual/range {v1 .. v7}, Landroid/support/v4/widget/bm;->a(IIIIII)Z
...
.method public computeScroll()V
    ...
    invoke-virtual {v1}, Landroid/support/v4/widget/bm;->g()Z
    ...
    invoke-virtual {v1}, Landroid/support/v4/widget/bm;->b()I

    move-result v1

    iget-object v2, p0, Landroid/support/v4/widget/NestedScrollView;->c:Landroid/support/v4/widget/bm;

    invoke-virtual {v2}, Landroid/support/v4/widget/bm;->c()I
    ...
    invoke-virtual {v1}, Landroid/support/v4/widget/bm;->f()F
...
.method public d(I)V
    ...
    invoke-virtual/range {v0 .. v10}, Landroid/support/v4/widget/bm;->a(IIIIIIIIII)V
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v1, p0, Landroid/support/v4/widget/NestedScrollView;->d:Landroid/support/v4/widget/ah;
    ...
    iget-object v3, p0, Landroid/support/v4/widget/NestedScrollView;->d:Landroid/support/v4/widget/ah;
    ...
    iget-object v2, p0, Landroid/support/v4/widget/NestedScrollView;->d:Landroid/support/v4/widget/ah;
    ...
    :cond_1
    iget-object v1, p0, Landroid/support/v4/widget/NestedScrollView;->e:Landroid/support/v4/widget/ah;
    ...
    invoke-virtual {v0, v2, v3}, Landroid/support/v4/widget/ah;->a(II)V
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-static {p1, v1}, Landroid/support/v4/view/ba;->a(Landroid/view/MotionEvent;I)I
    ...
    invoke-virtual {v1}, Landroid/support/v4/widget/bm;->a()Z
    ...
    invoke-virtual/range {v0 .. v6}, Landroid/support/v4/widget/bm;->a(IIIIII)Z
...
.method protected onScrollChanged(IIII)V
    ...
    invoke-interface/range {v0 .. v5}, Landroid/support/v4/widget/ay;->a(Landroid/support/v4/widget/NestedScrollView;IIII)V
...
.method public onStopNestedScroll(Landroid/view/View;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/view/bm;->a(Landroid/view/View;)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v2, v0, Landroid/support/v4/widget/NestedScrollView;->c:Landroid/support/v4/widget/bm;

    invoke-virtual {v2}, Landroid/support/v4/widget/bm;->a()Z
    ...
    invoke-virtual {v2}, Landroid/support/v4/widget/bm;->h()V
    ...
    invoke-static/range {p0 .. p0}, Landroid/support/v4/view/bw;->a(Landroid/view/View;)I
    ...
    iget-object v2, v0, Landroid/support/v4/widget/NestedScrollView;->d:Landroid/support/v4/widget/ah;
    ...
    iget-object v2, v0, Landroid/support/v4/widget/NestedScrollView;->e:Landroid/support/v4/widget/ah;

    invoke-virtual {v2}, Landroid/support/v4/widget/ah;->a()Z
    ...
    invoke-virtual {v2}, Landroid/support/v4/widget/ah;->c()Z
    ...
    :cond_10
    invoke-static/range {p0 .. p0}, Landroid/support/v4/view/bw;->d(Landroid/view/View;)V
    ...
    invoke-static {v2, v3}, Landroid/support/v4/view/br;->b(Landroid/view/VelocityTracker;I)F
    ...
    invoke-virtual/range {v2 .. v8}, Landroid/support/v4/widget/bm;->a(IIIIII)Z
