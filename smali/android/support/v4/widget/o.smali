...
.field protected f:Landroid/support/v4/widget/q;

.field protected g:Landroid/database/DataSetObserver;

.field protected h:Landroid/support/v4/widget/s;
...
.method public constructor <init>(Landroid/content/Context;Landroid/database/Cursor;Z)V
    ...
    :goto_0
    invoke-virtual {p0, p1, p2, v0}, Landroid/support/v4/widget/o;->a(Landroid/content/Context;Landroid/database/Cursor;I)V
...
.method a(Landroid/content/Context;Landroid/database/Cursor;I)V
    ...
    :goto_1
    iput-object p2, p0, Landroid/support/v4/widget/o;->c:Landroid/database/Cursor;
    ...
    invoke-direct {v1, p0}, Landroid/support/v4/widget/q;-><init>(Landroid/support/v4/widget/o;)V

    iput-object v1, p0, Landroid/support/v4/widget/o;->f:Landroid/support/v4/widget/q;

    new-instance v1, Landroid/support/v4/widget/r;

    invoke-direct {v1, p0, v3}, Landroid/support/v4/widget/r;-><init>(Landroid/support/v4/widget/o;Landroid/support/v4/widget/p;)V

    iput-object v1, p0, Landroid/support/v4/widget/o;->g:Landroid/database/DataSetObserver;

    :goto_3
    if-eqz v0, :cond_1

    iget-object v0, p0, Landroid/support/v4/widget/o;->f:Landroid/support/v4/widget/q;
    ...
    :cond_0
    iget-object v0, p0, Landroid/support/v4/widget/o;->g:Landroid/database/DataSetObserver;
    ...
    :cond_2
    iput-boolean v1, p0, Landroid/support/v4/widget/o;->b:Z
    ...
    :cond_5
    iput-object v3, p0, Landroid/support/v4/widget/o;->f:Landroid/support/v4/widget/q;

    iput-object v3, p0, Landroid/support/v4/widget/o;->g:Landroid/database/DataSetObserver;
...
.method public a(Landroid/database/Cursor;)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/v4/widget/o;->b(Landroid/database/Cursor;)Landroid/database/Cursor;
...
.method public b(Landroid/database/Cursor;)Landroid/database/Cursor;
    ...
    iget-object v1, p0, Landroid/support/v4/widget/o;->f:Landroid/support/v4/widget/q;
...
.method protected b()V
    ...
    iget-boolean v0, p0, Landroid/support/v4/widget/o;->b:Z
...
.method public getDropDownView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    invoke-virtual {p0, p2, v0, v1}, Landroid/support/v4/widget/o;->a(Landroid/view/View;Landroid/content/Context;Landroid/database/Cursor;)V
...
.method public getFilter()Landroid/widget/Filter;
    ...
    iget-object v0, p0, Landroid/support/v4/widget/o;->h:Landroid/support/v4/widget/s;

    if-nez v0, :cond_0

    new-instance v0, Landroid/support/v4/widget/s;

    invoke-direct {v0, p0}, Landroid/support/v4/widget/s;-><init>(Landroid/support/v4/widget/t;)V

    iput-object v0, p0, Landroid/support/v4/widget/o;->h:Landroid/support/v4/widget/s;
