...
.field private C:Landroid/support/v4/widget/as;
...
.field private e:Landroid/support/v4/widget/cb;
...
.field private final j:Landroid/support/v4/view/bm;

.field private final k:Landroid/support/v4/view/bk;
...
.field private z:Landroid/support/v4/widget/e;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v0, p0}, Landroid/support/v4/widget/by;-><init>(Landroid/support/v4/widget/SwipeRefreshLayout;)V
    ...
    invoke-direct {v0, p0}, Landroid/support/v4/widget/bz;-><init>(Landroid/support/v4/widget/SwipeRefreshLayout;)V
    ...
    invoke-static {p0, v3}, Landroid/support/v4/view/bw;->a(Landroid/view/ViewGroup;Z)V
    ...
    iput-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->j:Landroid/support/v4/view/bm;

    new-instance v0, Landroid/support/v4/view/bk;

    invoke-direct {v0, p0}, Landroid/support/v4/view/bk;-><init>(Landroid/view/View;)V

    iput-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->k:Landroid/support/v4/view/bk;
...
.method private a(II)Landroid/view/animation/Animation;
    ...
    :cond_0
    new-instance v1, Landroid/support/v4/widget/bw;

    invoke-direct {v1, p0, p1, p2}, Landroid/support/v4/widget/bw;-><init>(Landroid/support/v4/widget/SwipeRefreshLayout;II)V

    const-wide/16 v2, 0x12c

    invoke-virtual {v1, v2, v3}, Landroid/view/animation/Animation;->setDuration(J)V

    iget-object v2, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->z:Landroid/support/v4/widget/e;

    invoke-virtual {v2, v0}, Landroid/support/v4/widget/e;->a(Landroid/view/animation/Animation$AnimationListener;)V

    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->z:Landroid/support/v4/widget/e;
...
.method private a(F)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/widget/as;->a(Z)V
    ...
    iget-object v1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->z:Landroid/support/v4/widget/e;
    ...
    invoke-static {v1, v10}, Landroid/support/v4/view/bw;->d(Landroid/view/View;F)V

    iget-object v1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->z:Landroid/support/v4/widget/e;

    invoke-static {v1, v10}, Landroid/support/v4/view/bw;->e(Landroid/view/View;F)V
    ...
    invoke-virtual {v4, v12, v1}, Landroid/support/v4/widget/as;->a(FF)V
    ...
    invoke-virtual {v2, v1}, Landroid/support/v4/widget/as;->b(F)V
...
.method static synthetic b(Landroid/support/v4/widget/SwipeRefreshLayout;)Landroid/support/v4/widget/as;
    .locals 1
...
.method private b(F)V
    ...
    invoke-virtual {v0, v1, v1}, Landroid/support/v4/widget/as;->a(FF)V
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/widget/as;->a(Z)V
...
.method private c(ILandroid/view/animation/Animation$AnimationListener;)V
    ...
    invoke-virtual {v0}, Landroid/support/v4/widget/as;->getAlpha()I
    ...
    invoke-direct {v0, p0}, Landroid/support/v4/widget/ca;-><init>(Landroid/support/v4/widget/SwipeRefreshLayout;)V
    ...
    invoke-static {v0}, Landroid/support/v4/view/bw;->s(Landroid/view/View;)F
...
.method static synthetic d(Landroid/support/v4/widget/SwipeRefreshLayout;)Landroid/support/v4/widget/cb;
    .locals 1

    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->e:Landroid/support/v4/widget/cb;
...
.method private d()V
    ...
    iput-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->z:Landroid/support/v4/widget/e;
    ...
    invoke-direct {v0, v1, p0}, Landroid/support/v4/widget/as;-><init>(Landroid/content/Context;Landroid/view/View;)V

    iput-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->C:Landroid/support/v4/widget/as;

    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->C:Landroid/support/v4/widget/as;

    invoke-virtual {v0, v3}, Landroid/support/v4/widget/as;->b(I)V
...
.method private setAnimationProgress(F)V
    ...
    invoke-static {v0, p1}, Landroid/support/v4/view/bw;->e(Landroid/view/View;F)V
...
.method public dispatchNestedFling(FFZ)Z
    ...
    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->k:Landroid/support/v4/view/bk;
...
.method public getNestedScrollAxes()I
    ...
    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->j:Landroid/support/v4/view/bm;
...
.method protected onLayout(ZIIII)V
    ...
    iget-object v3, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->z:Landroid/support/v4/widget/e;
...
.method public setOnRefreshListener(Landroid/support/v4/widget/cb;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->e:Landroid/support/v4/widget/cb;
