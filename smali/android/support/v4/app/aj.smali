...
.field o:Landroid/support/v4/app/ag;

.field p:Landroid/support/v4/app/ae;
...
.method static constructor <clinit>()V
    ...
    :cond_0
    sput-boolean v0, Landroid/support/v4/app/aj;->b:Z

    const/4 v0, 0x0

    sput-object v0, Landroid/support/v4/app/aj;->r:Ljava/lang/reflect/Field;

    new-instance v0, Landroid/view/animation/DecelerateInterpolator;

    invoke-direct {v0, v4}, Landroid/view/animation/DecelerateInterpolator;-><init>(F)V

    sput-object v0, Landroid/support/v4/app/aj;->A:Landroid/view/animation/Interpolator;

    new-instance v0, Landroid/view/animation/DecelerateInterpolator;

    invoke-direct {v0, v3}, Landroid/view/animation/DecelerateInterpolator;-><init>(F)V

    sput-object v0, Landroid/support/v4/app/aj;->B:Landroid/view/animation/Interpolator;

    new-instance v0, Landroid/view/animation/AccelerateInterpolator;

    invoke-direct {v0, v4}, Landroid/view/animation/AccelerateInterpolator;-><init>(F)V

    sput-object v0, Landroid/support/v4/app/aj;->C:Landroid/view/animation/Interpolator;

    new-instance v0, Landroid/view/animation/AccelerateInterpolator;

    invoke-direct {v0, v3}, Landroid/view/animation/AccelerateInterpolator;-><init>(F)V

    sput-object v0, Landroid/support/v4/app/aj;->D:Landroid/view/animation/Interpolator;
...
.method constructor <init>()V
    ...
    iput v0, p0, Landroid/support/v4/app/aj;->n:I

    iput-object v1, p0, Landroid/support/v4/app/aj;->x:Landroid/os/Bundle;

    iput-object v1, p0, Landroid/support/v4/app/aj;->y:Landroid/util/SparseArray;

    new-instance v0, Landroid/support/v4/app/ak;

    invoke-direct {v0, p0}, Landroid/support/v4/app/ak;-><init>(Landroid/support/v4/app/aj;)V

    iput-object v0, p0, Landroid/support/v4/app/aj;->z:Ljava/lang/Runnable;
...
.method static a(Landroid/content/Context;FF)Landroid/view/animation/Animation;
    ...
    sget-object v1, Landroid/support/v4/app/aj;->B:Landroid/view/animation/Interpolator;
...
.method static a(Landroid/content/Context;FFFF)Landroid/view/animation/Animation;
    ...
    sget-object v1, Landroid/support/v4/app/aj;->A:Landroid/view/animation/Interpolator;
...
.method private a(Ljava/lang/RuntimeException;)V
    ...
    iget-object v0, p0, Landroid/support/v4/app/aj;->o:Landroid/support/v4/app/ag;
    ...
    invoke-virtual {v0, v2, v3, v1, v4}, Landroid/support/v4/app/ag;->a(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    :try_end_0
...
.method static a(Landroid/view/View;Landroid/view/animation/Animation;)Z
    ...
    invoke-static {p1}, Landroid/support/v4/app/aj;->a(Landroid/view/animation/Animation;)Z
...
.method private b(Landroid/view/View;Landroid/view/animation/Animation;)V
    ...
    :cond_1
    invoke-static {p1, p2}, Landroid/support/v4/app/aj;->a(Landroid/view/View;Landroid/view/animation/Animation;)Z
    ...
    :try_start_0
    sget-object v0, Landroid/support/v4/app/aj;->r:Ljava/lang/reflect/Field;
...
.method private u()V
    ...
    iget-boolean v0, p0, Landroid/support/v4/app/aj;->t:Z
    ...
    :cond_0
    iget-object v0, p0, Landroid/support/v4/app/aj;->v:Ljava/lang/String;
    ...
    iget-object v2, p0, Landroid/support/v4/app/aj;->v:Ljava/lang/String;
...
.method public a(Landroid/support/v4/app/n;)I
    ...
    :try_start_0
    iget-object v0, p0, Landroid/support/v4/app/aj;->l:Ljava/util/ArrayList;
    ...
    :cond_0
    iget-object v0, p0, Landroid/support/v4/app/aj;->k:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Landroid/support/v4/app/aj;->k:Ljava/util/ArrayList;
    ...
    sget-boolean v1, Landroid/support/v4/app/aj;->a:Z
    ...
    :cond_2
    iget-object v1, p0, Landroid/support/v4/app/aj;->k:Ljava/util/ArrayList;
    ...
    iget-object v1, p0, Landroid/support/v4/app/aj;->l:Ljava/util/ArrayList;
...
.method public a(Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/Fragment$SavedState;
    ...
    invoke-direct {p0, v1}, Landroid/support/v4/app/aj;->a(Ljava/lang/RuntimeException;)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/v4/app/aj;->g(Landroid/support/v4/app/Fragment;)Landroid/os/Bundle;
...
.method public a(I)Landroid/support/v4/app/Fragment;
    ...
    iget-object v0, p0, Landroid/support/v4/app/aj;->g:Ljava/util/ArrayList;
    ...
    :cond_2
    iget-object v0, p0, Landroid/support/v4/app/aj;->f:Ljava/util/ArrayList;
...
.method public a(Landroid/os/Bundle;Ljava/lang/String;)Landroid/support/v4/app/Fragment;
    ...
    invoke-direct {p0, v0}, Landroid/support/v4/app/aj;->a(Ljava/lang/RuntimeException;)V
    ...
    invoke-direct {p0, v2}, Landroid/support/v4/app/aj;->a(Ljava/lang/RuntimeException;)V
...
.method public a()Landroid/support/v4/app/au;
    ...
    invoke-direct {v0, p0}, Landroid/support/v4/app/n;-><init>(Landroid/support/v4/app/aj;)V
...
.method public a(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    invoke-virtual {v0}, Landroid/support/v4/app/ag;->i()Landroid/content/Context;
    ...
    :cond_5
    sget-boolean v4, Landroid/support/v4/app/aj;->a:Z
    ...
    iput-object p0, v4, Landroid/support/v4/app/Fragment;->mFragmentManager:Landroid/support/v4/app/aj;

    iget-object v0, p0, Landroid/support/v4/app/aj;->o:Landroid/support/v4/app/ag;

    iput-object v0, v4, Landroid/support/v4/app/Fragment;->mHost:Landroid/support/v4/app/ag;
    ...
    invoke-virtual {p0, v4, v2}, Landroid/support/v4/app/aj;->a(Landroid/support/v4/app/Fragment;Z)V

    move-object v1, v4

    :goto_5
    iget v0, p0, Landroid/support/v4/app/aj;->n:I
    ...
    iget-object v1, p0, Landroid/support/v4/app/aj;->o:Landroid/support/v4/app/ag;

    iput-object v1, v0, Landroid/support/v4/app/Fragment;->mHost:Landroid/support/v4/app/ag;
    ...
    :cond_c
    invoke-virtual {p0, v1}, Landroid/support/v4/app/aj;->c(Landroid/support/v4/app/Fragment;)V
...
.method a(Landroid/support/v4/app/Fragment;IZI)Landroid/view/animation/Animation;
    ...
    :cond_3
    invoke-static {p2, p3}, Landroid/support/v4/app/aj;->b(IZ)I
    ...
    invoke-static {v0, v1, v3, v4, v3}, Landroid/support/v4/app/aj;->a(Landroid/content/Context;FFFF)Landroid/view/animation/Animation;
    ...
    invoke-static {v0, v3, v5, v3, v4}, Landroid/support/v4/app/aj;->a(Landroid/content/Context;FFFF)Landroid/view/animation/Animation;
    ...
    invoke-static {v0, v5, v3, v4, v3}, Landroid/support/v4/app/aj;->a(Landroid/content/Context;FFFF)Landroid/view/animation/Animation;
    ...
    invoke-static {v0, v3, v1, v3, v4}, Landroid/support/v4/app/aj;->a(Landroid/content/Context;FFFF)Landroid/view/animation/Animation;
    ...
    invoke-static {v0, v4, v3}, Landroid/support/v4/app/aj;->a(Landroid/content/Context;FF)Landroid/view/animation/Animation;
    ...
    invoke-static {v0, v3, v4}, Landroid/support/v4/app/aj;->a(Landroid/content/Context;FF)Landroid/view/animation/Animation;
...
.method public a(II)V
    ...
    invoke-direct {v0, p0, p1, p2}, Landroid/support/v4/app/al;-><init>(Landroid/support/v4/app/aj;II)V

    const/4 v1, 0x0

    invoke-virtual {p0, v0, v1}, Landroid/support/v4/app/aj;->a(Ljava/lang/Runnable;Z)V
...
.method a(IIIZ)V
    ...
    :cond_2
    iput p1, p0, Landroid/support/v4/app/aj;->n:I
    ...
    iget-object v0, v1, Landroid/support/v4/app/Fragment;->mLoaderManager:Landroid/support/v4/app/be;

    if-eqz v0, :cond_5

    iget-object v0, v1, Landroid/support/v4/app/Fragment;->mLoaderManager:Landroid/support/v4/app/be;

    invoke-virtual {v0}, Landroid/support/v4/app/be;->a()Z
    ...
    invoke-virtual {p0}, Landroid/support/v4/app/aj;->d()V

    :cond_4
    iget-boolean v0, p0, Landroid/support/v4/app/aj;->s:Z
    ...
    iput-boolean v5, p0, Landroid/support/v4/app/aj;->s:Z
...
.method public a(ILandroid/support/v4/app/n;)V
    ...
    iput-object v1, p0, Landroid/support/v4/app/aj;->l:Ljava/util/ArrayList;
...
.method a(IZ)V
    ...
    invoke-virtual {p0, p1, v0, v0, p2}, Landroid/support/v4/app/aj;->a(IIIZ)V
...
.method a(Landroid/os/Parcelable;Ljava/util/List;)V
    ...
    iget-object v5, p0, Landroid/support/v4/app/aj;->o:Landroid/support/v4/app/ag;

    invoke-virtual {v5}, Landroid/support/v4/app/ag;->i()Landroid/content/Context;
    ...
    iput-object v0, p0, Landroid/support/v4/app/aj;->f:Ljava/util/ArrayList;

    iget-object v0, p0, Landroid/support/v4/app/aj;->h:Ljava/util/ArrayList;
    ...
    iget-object v3, p0, Landroid/support/v4/app/aj;->o:Landroid/support/v4/app/ag;

    iget-object v4, p0, Landroid/support/v4/app/aj;->q:Landroid/support/v4/app/Fragment;

    invoke-virtual {v1, v3, v4}, Landroid/support/v4/app/FragmentState;->a(Landroid/support/v4/app/ag;Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/Fragment;
    ...
    :cond_6
    iget-object v4, p0, Landroid/support/v4/app/aj;->f:Ljava/util/ArrayList;
    ...
    iput-object v1, p0, Landroid/support/v4/app/aj;->h:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Landroid/support/v4/app/aj;->g:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v3}, Landroid/support/v4/app/aj;->a(Ljava/lang/RuntimeException;)V
    ...
    :cond_f
    iget-object v3, p0, Landroid/support/v4/app/aj;->g:Ljava/util/ArrayList;
    ...
    :cond_11
    iput-object v7, p0, Landroid/support/v4/app/aj;->g:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Landroid/support/v4/app/aj;->i:Ljava/util/ArrayList;
    ...
    invoke-virtual {v1, p0}, Landroid/support/v4/app/BackStackState;->a(Landroid/support/v4/app/aj;)Landroid/support/v4/app/n;
    ...
    :cond_13
    iget-object v3, p0, Landroid/support/v4/app/aj;->i:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v3, v1}, Landroid/support/v4/app/aj;->a(ILandroid/support/v4/app/n;)V
    ...
    :cond_15
    iput-object v7, p0, Landroid/support/v4/app/aj;->i:Ljava/util/ArrayList;
...
.method public a(Landroid/support/v4/app/Fragment;II)V
    ...
    :cond_1
    iget-object v2, p0, Landroid/support/v4/app/aj;->g:Ljava/util/ArrayList;
    ...
    iput-boolean v1, p0, Landroid/support/v4/app/aj;->s:Z
...
.method a(Landroid/support/v4/app/Fragment;IIIZ)V
    ...
    iput-object v0, p1, Landroid/support/v4/app/Fragment;->mHost:Landroid/support/v4/app/ag;

    iget-object v0, p0, Landroid/support/v4/app/aj;->q:Landroid/support/v4/app/Fragment;
    ...
    iget-object v0, v0, Landroid/support/v4/app/Fragment;->mChildFragmentManager:Landroid/support/v4/app/aj;

    :goto_2
    iput-object v0, p1, Landroid/support/v4/app/Fragment;->mFragmentManager:Landroid/support/v4/app/aj;
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/app/ag;->b(Landroid/support/v4/app/Fragment;)V
    ...
    iget-object v0, p0, Landroid/support/v4/app/aj;->p:Landroid/support/v4/app/ae;
    ...
    invoke-virtual {p0, p1, p3, v5, p4}, Landroid/support/v4/app/aj;->a(Landroid/support/v4/app/Fragment;IZI)Landroid/view/animation/Animation;
    ...
    invoke-direct {p0, v2, v1}, Landroid/support/v4/app/aj;->b(Landroid/view/View;Landroid/view/animation/Animation;)V
    ...
    invoke-static {v0}, Landroid/support/v4/app/bl;->a(Landroid/view/View;)Landroid/view/ViewGroup;
    ...
    invoke-static {v1}, Landroid/support/v4/app/bl;->a(Landroid/view/View;)Landroid/view/ViewGroup;
    ...
    iget-boolean v0, p0, Landroid/support/v4/app/aj;->u:Z
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/app/ag;->a(Landroid/support/v4/app/Fragment;)Z
    ...
    invoke-virtual {p0, p1}, Landroid/support/v4/app/aj;->f(Landroid/support/v4/app/Fragment;)V
    ...
    invoke-virtual {p0, p1, p3, v3, p4}, Landroid/support/v4/app/aj;->a(Landroid/support/v4/app/Fragment;IZI)Landroid/view/animation/Animation;
    ...
    invoke-direct {v2, p0, v1, v0, p1}, Landroid/support/v4/app/am;-><init>(Landroid/support/v4/app/aj;Landroid/view/View;Landroid/view/animation/Animation;Landroid/support/v4/app/Fragment;)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/v4/app/aj;->e(Landroid/support/v4/app/Fragment;)V

    goto/16 :goto_1

    :cond_31
    iput-object v7, p1, Landroid/support/v4/app/Fragment;->mHost:Landroid/support/v4/app/ag;

    iput-object v7, p1, Landroid/support/v4/app/Fragment;->mParentFragment:Landroid/support/v4/app/Fragment;

    iput-object v7, p1, Landroid/support/v4/app/Fragment;->mFragmentManager:Landroid/support/v4/app/aj;

    iput-object v7, p1, Landroid/support/v4/app/Fragment;->mChildFragmentManager:Landroid/support/v4/app/aj;
...
.method public a(Landroid/support/v4/app/Fragment;Z)V
    ...
    :cond_1
    invoke-virtual {p0, p1}, Landroid/support/v4/app/aj;->d(Landroid/support/v4/app/Fragment;)V
    ...
    iput-boolean v3, p0, Landroid/support/v4/app/aj;->s:Z

    :cond_3
    if-eqz p2, :cond_4

    invoke-virtual {p0, p1}, Landroid/support/v4/app/aj;->c(Landroid/support/v4/app/Fragment;)V

    :cond_4
    return-void
.end method

.method public a(Landroid/support/v4/app/ag;Landroid/support/v4/app/ae;Landroid/support/v4/app/Fragment;)V
    .locals 2
    ...
    :cond_0
    iput-object p1, p0, Landroid/support/v4/app/aj;->o:Landroid/support/v4/app/ag;

    iput-object p2, p0, Landroid/support/v4/app/aj;->p:Landroid/support/v4/app/ae;

    iput-object p3, p0, Landroid/support/v4/app/aj;->q:Landroid/support/v4/app/Fragment;
...
.method public a(Ljava/lang/Runnable;Z)V
    ...
    invoke-direct {p0}, Landroid/support/v4/app/aj;->u()V
    ...
    :cond_2
    :try_start_1
    iget-object v0, p0, Landroid/support/v4/app/aj;->c:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Landroid/support/v4/app/aj;->c:Ljava/util/ArrayList;
    ...
    invoke-virtual {v0}, Landroid/support/v4/app/ag;->j()Landroid/os/Handler;

    move-result-object v0

    iget-object v1, p0, Landroid/support/v4/app/aj;->z:Ljava/lang/Runnable;
...
.method public a(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    :cond_3
    iget-object v0, p0, Landroid/support/v4/app/aj;->i:Ljava/util/ArrayList;
...
.method a(Landroid/os/Handler;Ljava/lang/String;II)Z
    ...
    iget-object v1, p0, Landroid/support/v4/app/aj;->i:Ljava/util/ArrayList;
    ...
    iget-object v5, p0, Landroid/support/v4/app/aj;->i:Ljava/util/ArrayList;
...
.method public a(Landroid/view/Menu;)Z
    ...
    iget-object v1, p0, Landroid/support/v4/app/aj;->g:Ljava/util/ArrayList;
...
.method public a(Landroid/view/Menu;Landroid/view/MenuInflater;)Z
    ...
    :cond_6
    iput-object v1, p0, Landroid/support/v4/app/aj;->j:Ljava/util/ArrayList;
...
.method public b(I)V
    ...
    iput-object v0, p0, Landroid/support/v4/app/aj;->l:Ljava/util/ArrayList;
...
.method public b(Landroid/support/v4/app/Fragment;)V
    ...
    iput-boolean v0, p0, Landroid/support/v4/app/aj;->w:Z
    ...
    iget v2, p0, Landroid/support/v4/app/aj;->n:I
...
.method public b(Landroid/support/v4/app/Fragment;II)V
    ...
    invoke-virtual {p0, p1, p2, v0, p3}, Landroid/support/v4/app/aj;->a(Landroid/support/v4/app/Fragment;IZI)Landroid/view/animation/Animation;
    ...
    invoke-direct {p0, v1, v0}, Landroid/support/v4/app/aj;->b(Landroid/view/View;Landroid/view/animation/Animation;)V
...
.method public b()Z
    ...
    invoke-virtual {p0}, Landroid/support/v4/app/aj;->e()Z
...
.method public c(Landroid/support/v4/app/Fragment;II)V
    ...
    invoke-virtual {p0, p1, p2, v4, p3}, Landroid/support/v4/app/aj;->a(Landroid/support/v4/app/Fragment;IZI)Landroid/view/animation/Animation;
    ...
    iput-boolean v4, p0, Landroid/support/v4/app/aj;->s:Z
...
.method public c()Z
    ...
    invoke-virtual {p0, v0, v1, v2, v3}, Landroid/support/v4/app/aj;->a(Landroid/os/Handler;Ljava/lang/String;II)Z
...
.method d()V
    ...
    invoke-virtual {p0, v0}, Landroid/support/v4/app/aj;->b(Landroid/support/v4/app/Fragment;)V
...
.method d(Landroid/support/v4/app/Fragment;)V
    ...
    iget-object v1, p0, Landroid/support/v4/app/aj;->q:Landroid/support/v4/app/Fragment;
...
.method public d(Landroid/support/v4/app/Fragment;II)V
    ...
    iput-boolean v2, p0, Landroid/support/v4/app/aj;->s:Z
...
.method e(Landroid/support/v4/app/Fragment;)V
    ...
    iput-object v0, p0, Landroid/support/v4/app/aj;->h:Ljava/util/ArrayList;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/app/ag;->b(Ljava/lang/String;)V
...
.method public e()Z
    ...
    invoke-virtual {v3}, Landroid/support/v4/app/ag;->j()Landroid/os/Handler;
    ...
    :try_start_0
    iget-object v3, p0, Landroid/support/v4/app/aj;->c:Ljava/util/ArrayList;
    ...
    iget-boolean v0, p0, Landroid/support/v4/app/aj;->w:Z
    ...
    iget-object v5, v0, Landroid/support/v4/app/Fragment;->mLoaderManager:Landroid/support/v4/app/be;

    if-eqz v5, :cond_3

    iget-object v0, v0, Landroid/support/v4/app/Fragment;->mLoaderManager:Landroid/support/v4/app/be;
    ...
    :cond_4
    :try_start_1
    iget-object v1, p0, Landroid/support/v4/app/aj;->c:Ljava/util/ArrayList;

    invoke-virtual {v1}, Ljava/util/ArrayList;->size()I

    move-result v3

    iget-object v1, p0, Landroid/support/v4/app/aj;->d:[Ljava/lang/Runnable;
    ...
    iput-object v1, p0, Landroid/support/v4/app/aj;->d:[Ljava/lang/Runnable;

    :cond_6
    iget-object v1, p0, Landroid/support/v4/app/aj;->c:Ljava/util/ArrayList;

    iget-object v4, p0, Landroid/support/v4/app/aj;->d:[Ljava/lang/Runnable;
    ...
    iget-object v4, p0, Landroid/support/v4/app/aj;->z:Ljava/lang/Runnable;
    ...
    :cond_7
    iput-boolean v2, p0, Landroid/support/v4/app/aj;->e:Z
    ...
    iput-boolean v2, p0, Landroid/support/v4/app/aj;->w:Z
...
.method f()V
    ...
    iget-object v0, p0, Landroid/support/v4/app/aj;->m:Ljava/util/ArrayList;
    ...
    invoke-interface {v0}, Landroid/support/v4/app/ai;->a()V
...
.method f(Landroid/support/v4/app/Fragment;)V
    ...
    :cond_1
    iget-object v0, p0, Landroid/support/v4/app/aj;->y:Landroid/util/SparseArray;
    ...
    iput-object v0, p0, Landroid/support/v4/app/aj;->y:Landroid/util/SparseArray;

    :goto_1
    iget-object v0, p1, Landroid/support/v4/app/Fragment;->mInnerView:Landroid/view/View;

    iget-object v1, p0, Landroid/support/v4/app/aj;->y:Landroid/util/SparseArray;
...
.method g(Landroid/support/v4/app/Fragment;)Landroid/os/Bundle;
    ...
    iget-object v0, p0, Landroid/support/v4/app/aj;->x:Landroid/os/Bundle;
    ...
    iput-object v0, p0, Landroid/support/v4/app/aj;->x:Landroid/os/Bundle;
...
.method g()Ljava/util/ArrayList;
    ...
    sget-boolean v2, Landroid/support/v4/app/aj;->a:Z
...
.method h()Landroid/os/Parcelable;
    ...
    sget-boolean v0, Landroid/support/v4/app/aj;->b:Z

    if-eqz v0, :cond_0

    iput-boolean v1, p0, Landroid/support/v4/app/aj;->t:Z
    ...
    invoke-virtual {p0, v0}, Landroid/support/v4/app/aj;->g(Landroid/support/v4/app/Fragment;)Landroid/os/Bundle;
    ...
    invoke-direct {p0, v8}, Landroid/support/v4/app/aj;->a(Ljava/lang/RuntimeException;)V
    ...
    invoke-virtual {p0, v8, v9, v10}, Landroid/support/v4/app/aj;->a(Landroid/os/Bundle;Ljava/lang/String;Landroid/support/v4/app/Fragment;)V
    ...
    :cond_6
    :goto_2
    sget-boolean v8, Landroid/support/v4/app/aj;->a:Z
    ...
    iget-object v8, p0, Landroid/support/v4/app/aj;->g:Ljava/util/ArrayList;
    ...
    iget-object v6, p0, Landroid/support/v4/app/aj;->i:Ljava/util/ArrayList;
...
.method public i()V
    ...
    iput-boolean v0, p0, Landroid/support/v4/app/aj;->t:Z
...
.method public j()V
    ...
    invoke-virtual {p0, v0, v1}, Landroid/support/v4/app/aj;->a(IZ)V
...
.method public r()V
    ...
    iput-boolean v0, p0, Landroid/support/v4/app/aj;->u:Z

    invoke-virtual {p0}, Landroid/support/v4/app/aj;->e()Z

    invoke-virtual {p0, v2, v2}, Landroid/support/v4/app/aj;->a(IZ)V

    iput-object v1, p0, Landroid/support/v4/app/aj;->o:Landroid/support/v4/app/ag;

    iput-object v1, p0, Landroid/support/v4/app/aj;->p:Landroid/support/v4/app/ae;

    iput-object v1, p0, Landroid/support/v4/app/aj;->q:Landroid/support/v4/app/Fragment;
