.class public Landroid/support/v4/app/cs;
...
.method public constructor <init>(Landroid/content/Context;Landroid/app/Notification;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Landroid/widget/RemoteViews;ILandroid/app/PendingIntent;Landroid/app/PendingIntent;Landroid/graphics/Bitmap;IIZZILjava/lang/CharSequence;ZLandroid/os/Bundle;Ljava/lang/String;ZLjava/lang/String;)V
    ...
    iput-object v4, p0, Landroid/support/v4/app/cs;->c:Ljava/util/List;
    ...
    iput-object v4, p0, Landroid/support/v4/app/cs;->a:Landroid/app/Notification$Builder;

    new-instance v4, Landroid/os/Bundle;

    invoke-direct {v4}, Landroid/os/Bundle;-><init>()V

    iput-object v4, p0, Landroid/support/v4/app/cs;->b:Landroid/os/Bundle;

    if-eqz p18, :cond_0

    iget-object v4, p0, Landroid/support/v4/app/cs;->b:Landroid/os/Bundle;
...
.method public a()Landroid/app/Notification$Builder;
    ...
    iget-object v0, p0, Landroid/support/v4/app/cs;->a:Landroid/app/Notification$Builder;

    return-object v0
.end method

.method public a(Landroid/support/v4/app/cl;)V
    .locals 2

    iget-object v0, p0, Landroid/support/v4/app/cs;->c:Ljava/util/List;

    iget-object v1, p0, Landroid/support/v4/app/cs;->a:Landroid/app/Notification$Builder;

    invoke-static {v1, p1}, Landroid/support/v4/app/cr;->a(Landroid/app/Notification$Builder;Landroid/support/v4/app/cl;)Landroid/os/Bundle;
...
.method public b()Landroid/app/Notification;
    ...
    invoke-static {v1}, Landroid/support/v4/app/cr;->a(Landroid/app/Notification;)Landroid/os/Bundle;

    move-result-object v2

    new-instance v3, Landroid/os/Bundle;

    iget-object v0, p0, Landroid/support/v4/app/cs;->b:Landroid/os/Bundle;
    ...
    invoke-static {v0}, Landroid/support/v4/app/cr;->a(Ljava/util/List;)Landroid/util/SparseArray;
