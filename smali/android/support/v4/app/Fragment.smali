...
.field private static final sClassMap:Landroid/support/v4/g/q;
...
.field mChildFragmentManager:Landroid/support/v4/app/aj;
...
.field mEnterTransitionCallback:Landroid/support/v4/app/dg;

.field mExitTransition:Ljava/lang/Object;

.field mExitTransitionCallback:Landroid/support/v4/app/dg;

.field mFragmentId:I

.field mFragmentManager:Landroid/support/v4/app/aj;
...
.field mHost:Landroid/support/v4/app/ag;
...
.field mLoaderManager:Landroid/support/v4/app/be;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/app/Fragment;->sClassMap:Landroid/support/v4/g/q;
...
.method public constructor <init>()V
    ...
    iput-object v1, p0, Landroid/support/v4/app/Fragment;->mEnterTransitionCallback:Landroid/support/v4/app/dg;

    iput-object v1, p0, Landroid/support/v4/app/Fragment;->mExitTransitionCallback:Landroid/support/v4/app/dg;
...
.method public static instantiate(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;)Landroid/support/v4/app/Fragment;
    ...
    :try_start_0
    sget-object v0, Landroid/support/v4/app/Fragment;->sClassMap:Landroid/support/v4/g/q;
    ...
    sget-object v1, Landroid/support/v4/app/Fragment;->sClassMap:Landroid/support/v4/g/q;
    ...
    invoke-direct {v1, v2, v0}, Landroid/support/v4/app/y;-><init>(Ljava/lang/String;Ljava/lang/Exception;)V
...
.method public dump(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-object v0, p0, Landroid/support/v4/app/Fragment;->mFragmentManager:Landroid/support/v4/app/aj;
    ...
    :cond_0
    iget-object v0, p0, Landroid/support/v4/app/Fragment;->mHost:Landroid/support/v4/app/ag;
    ...
    :cond_b
    iget-object v0, p0, Landroid/support/v4/app/Fragment;->mLoaderManager:Landroid/support/v4/app/be;
    ...
    :cond_c
    iget-object v0, p0, Landroid/support/v4/app/Fragment;->mChildFragmentManager:Landroid/support/v4/app/aj;
    ...
    iget-object v1, p0, Landroid/support/v4/app/Fragment;->mChildFragmentManager:Landroid/support/v4/app/aj;
...
.method public final getActivity()Landroid/support/v4/app/aa;
    .locals 1
    ...
    invoke-virtual {v0}, Landroid/support/v4/app/ag;->h()Landroid/app/Activity;
...
.method public final getChildFragmentManager()Landroid/support/v4/app/ah;
    .locals 2
...
.method public final getFragmentManager()Landroid/support/v4/app/ah;
    .locals 1
...
.method public final getHost()Ljava/lang/Object;
    ...
    invoke-virtual {v0}, Landroid/support/v4/app/ag;->g()Ljava/lang/Object;
...
.method public getLayoutInflater(Landroid/os/Bundle;)Landroid/view/LayoutInflater;
    ...
    invoke-virtual {v0}, Landroid/support/v4/app/ag;->b()Landroid/view/LayoutInflater;

    move-result-object v0

    invoke-virtual {p0}, Landroid/support/v4/app/Fragment;->getChildFragmentManager()Landroid/support/v4/app/ah;

    iget-object v1, p0, Landroid/support/v4/app/Fragment;->mChildFragmentManager:Landroid/support/v4/app/aj;

    invoke-virtual {v1}, Landroid/support/v4/app/aj;->t()Landroid/support/v4/view/am;
...
.method public getLoaderManager()Landroid/support/v4/app/bc;
    .locals 4
    ...
    invoke-virtual {v0, v1, v2, v3}, Landroid/support/v4/app/ag;->a(Ljava/lang/String;ZZ)Landroid/support/v4/app/be;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v4/app/Fragment;->mLoaderManager:Landroid/support/v4/app/be;
...
.method initState()V
    ...
    iput-object v2, p0, Landroid/support/v4/app/Fragment;->mFragmentManager:Landroid/support/v4/app/aj;

    iput-object v2, p0, Landroid/support/v4/app/Fragment;->mChildFragmentManager:Landroid/support/v4/app/aj;

    iput-object v2, p0, Landroid/support/v4/app/Fragment;->mHost:Landroid/support/v4/app/ag;
    ...
    iput-object v2, p0, Landroid/support/v4/app/Fragment;->mLoaderManager:Landroid/support/v4/app/be;
...
.method instantiateChildFragmentManager()V
    ...
    iput-object v0, p0, Landroid/support/v4/app/Fragment;->mChildFragmentManager:Landroid/support/v4/app/aj;

    iget-object v0, p0, Landroid/support/v4/app/Fragment;->mChildFragmentManager:Landroid/support/v4/app/aj;

    iget-object v1, p0, Landroid/support/v4/app/Fragment;->mHost:Landroid/support/v4/app/ag;

    new-instance v2, Landroid/support/v4/app/x;

    invoke-direct {v2, p0}, Landroid/support/v4/app/x;-><init>(Landroid/support/v4/app/Fragment;)V

    invoke-virtual {v0, v1, v2, p0}, Landroid/support/v4/app/aj;->a(Landroid/support/v4/app/ag;Landroid/support/v4/app/ae;Landroid/support/v4/app/Fragment;)V
...
.method public onCreateContextMenu(Landroid/view/ContextMenu;Landroid/view/View;Landroid/view/ContextMenu$ContextMenuInfo;)V
    ...
    invoke-virtual {p0}, Landroid/support/v4/app/Fragment;->getActivity()Landroid/support/v4/app/aa;

    move-result-object v0

    invoke-virtual {v0, p1, p2, p3}, Landroid/support/v4/app/aa;->onCreateContextMenu(Landroid/view/ContextMenu;Landroid/view/View;Landroid/view/ContextMenu$ContextMenuInfo;)V
...
.method performContextItemSelected(Landroid/view/MenuItem;)Z
    ...
    invoke-virtual {v1, p1}, Landroid/support/v4/app/aj;->b(Landroid/view/MenuItem;)Z
...
.method performCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v1, v0, v2}, Landroid/support/v4/app/aj;->a(Landroid/os/Parcelable;Ljava/util/List;)V
...
.method performCreateOptionsMenu(Landroid/view/Menu;Landroid/view/MenuInflater;)Z
    ...
    invoke-virtual {v1, p1, p2}, Landroid/support/v4/app/aj;->a(Landroid/view/Menu;Landroid/view/MenuInflater;)Z
...
.method performDestroyView()V
    ...
    invoke-virtual {v0}, Landroid/support/v4/app/be;->f()V
...
.method performOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    invoke-virtual {v1, p1}, Landroid/support/v4/app/aj;->a(Landroid/view/MenuItem;)Z
...
.method performPrepareOptionsMenu(Landroid/view/Menu;)Z
    ...
    invoke-virtual {v1, p1}, Landroid/support/v4/app/aj;->a(Landroid/view/Menu;)Z
...
.method performReallyStop()V
    ...
    invoke-virtual {v0}, Landroid/support/v4/app/ag;->l()Z
...
.method performStart()V
    ...
    invoke-virtual {v0}, Landroid/support/v4/app/be;->g()V
...
.method public final requestPermissions([Ljava/lang/String;I)V
    ...
    invoke-virtual {v0, p0, p1, p2}, Landroid/support/v4/app/ag;->a(Landroid/support/v4/app/Fragment;[Ljava/lang/String;I)V
...
.method public setEnterSharedElementCallback(Landroid/support/v4/app/dg;)V
    ...
    iput-object p1, p0, Landroid/support/v4/app/Fragment;->mEnterTransitionCallback:Landroid/support/v4/app/dg;
...
.method public setExitSharedElementCallback(Landroid/support/v4/app/dg;)V
    ...
    iput-object p1, p0, Landroid/support/v4/app/Fragment;->mExitTransitionCallback:Landroid/support/v4/app/dg;
...
.method public setUserVisibleHint(Z)V
    ...
    invoke-virtual {v0, p0}, Landroid/support/v4/app/aj;->b(Landroid/support/v4/app/Fragment;)V
...
.method public shouldShowRequestPermissionRationale(Ljava/lang/String;)Z
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/app/ag;->a(Ljava/lang/String;)Z
...
.method public startActivity(Landroid/content/Intent;Landroid/os/Bundle;)V
    ...
    invoke-virtual {v0, p0, p1, v1, p2}, Landroid/support/v4/app/ag;->a(Landroid/support/v4/app/Fragment;Landroid/content/Intent;ILandroid/os/Bundle;)V
...
.method public startActivityForResult(Landroid/content/Intent;ILandroid/os/Bundle;)V
    ...
    invoke-virtual {v0, p0, p1, p2, p3}, Landroid/support/v4/app/ag;->a(Landroid/support/v4/app/Fragment;Landroid/content/Intent;ILandroid/os/Bundle;)V
