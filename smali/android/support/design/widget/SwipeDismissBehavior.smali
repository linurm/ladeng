...
# instance fields
.field private a:Landroid/support/v4/widget/cm;
...
.field private final j:Landroid/support/v4/widget/cp;
...
.method public constructor <init>()V
    ...
    invoke-direct {v0, p0}, Landroid/support/design/widget/br;-><init>(Landroid/support/design/widget/SwipeDismissBehavior;)V

    iput-object v0, p0, Landroid/support/design/widget/SwipeDismissBehavior;->j:Landroid/support/v4/widget/cp;
...
.method static synthetic a(Landroid/support/design/widget/SwipeDismissBehavior;)Landroid/support/design/widget/bs;
    .locals 1

    iget-object v0, p0, Landroid/support/design/widget/SwipeDismissBehavior;->b:Landroid/support/design/widget/bs;
...
.method private a(Landroid/view/ViewGroup;)V
    ...
    iget-object v0, p0, Landroid/support/design/widget/SwipeDismissBehavior;->a:Landroid/support/v4/widget/cm;
    ...
    iget-object v1, p0, Landroid/support/design/widget/SwipeDismissBehavior;->j:Landroid/support/v4/widget/cp;

    invoke-static {p1, v0, v1}, Landroid/support/v4/widget/cm;->a(Landroid/view/ViewGroup;FLandroid/support/v4/widget/cp;)Landroid/support/v4/widget/cm;

    move-result-object v0

    :goto_0
    iput-object v0, p0, Landroid/support/design/widget/SwipeDismissBehavior;->a:Landroid/support/v4/widget/cm;

    :cond_0
    return-void

    :cond_1
    iget-object v0, p0, Landroid/support/design/widget/SwipeDismissBehavior;->j:Landroid/support/v4/widget/cp;
...
.method static synthetic b(Landroid/support/design/widget/SwipeDismissBehavior;)Landroid/support/v4/widget/cm;
    .locals 1
...
.method public a(Landroid/support/design/widget/bs;)V
    ...
    iput-object p1, p0, Landroid/support/design/widget/SwipeDismissBehavior;->b:Landroid/support/design/widget/bs;
...
.method public b(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0, p3}, Landroid/support/v4/widget/cm;->b(Landroid/view/MotionEvent;)V
