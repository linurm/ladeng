...
.method public a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;IIII)Z
    ...
    invoke-static {v2}, Landroid/support/v4/view/bw;->w(Landroid/view/View;)Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-static {p2}, Landroid/support/v4/view/bw;->w(Landroid/view/View;)Z

    move-result v0

    if-nez v0, :cond_1

    invoke-static {p2, v6}, Landroid/support/v4/view/bw;->a(Landroid/view/View;Z)V
    ...
    :cond_1
    invoke-static {v2}, Landroid/support/v4/view/bw;->E(Landroid/view/View;)Z
...
.method protected b(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;I)V
    ...
    :cond_0
    invoke-super {p0, p1, p2, p3}, Landroid/support/design/widget/cm;->b(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;I)V
