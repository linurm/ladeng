...
# instance fields
.field private b:Landroid/support/design/widget/bv;
...
.method private a(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;Landroid/support/design/widget/FloatingActionButton;)Z
    ...
    invoke-static {p1, p2, v0}, Landroid/support/design/widget/cg;->b(Landroid/view/ViewGroup;Landroid/view/View;Landroid/graphics/Rect;)V
...
.method private c(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/FloatingActionButton;Landroid/view/View;)V
    ...
    :cond_0
    invoke-static {p2}, Landroid/support/v4/view/bw;->o(Landroid/view/View;)F

    move-result v1

    iget-object v2, p0, Landroid/support/design/widget/FloatingActionButton$Behavior;->b:Landroid/support/design/widget/bv;

    if-eqz v2, :cond_1

    iget-object v2, p0, Landroid/support/design/widget/FloatingActionButton$Behavior;->b:Landroid/support/design/widget/bv;

    invoke-virtual {v2}, Landroid/support/design/widget/bv;->b()Z
    ...
    invoke-virtual {v2}, Landroid/support/design/widget/bv;->e()V
    ...
    iput-object v2, p0, Landroid/support/design/widget/FloatingActionButton$Behavior;->b:Landroid/support/design/widget/bv;

    iget-object v2, p0, Landroid/support/design/widget/FloatingActionButton$Behavior;->b:Landroid/support/design/widget/bv;

    sget-object v3, Landroid/support/design/widget/a;->b:Landroid/view/animation/Interpolator;

    invoke-virtual {v2, v3}, Landroid/support/design/widget/bv;->a(Landroid/view/animation/Interpolator;)V
    ...
    invoke-virtual {v2, v3}, Landroid/support/design/widget/bv;->a(Landroid/support/design/widget/bx;)V

    :cond_2
    iget-object v2, p0, Landroid/support/design/widget/FloatingActionButton$Behavior;->b:Landroid/support/design/widget/bv;

    invoke-virtual {v2, v1, v0}, Landroid/support/design/widget/bv;->a(FF)V

    iget-object v1, p0, Landroid/support/design/widget/FloatingActionButton$Behavior;->b:Landroid/support/design/widget/bv;

    invoke-virtual {v1}, Landroid/support/design/widget/bv;->a()V
    ...
    :cond_3
    invoke-static {p2, v0}, Landroid/support/v4/view/bw;->b(Landroid/view/View;F)V
