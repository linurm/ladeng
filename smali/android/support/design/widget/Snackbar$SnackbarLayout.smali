...
.field private f:Landroid/support/design/widget/bi;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-static {p0, v1}, Landroid/support/v4/view/bw;->f(Landroid/view/View;F)V
    ...
    invoke-static {p0, v3}, Landroid/support/v4/view/bw;->d(Landroid/view/View;I)V

    invoke-static {p0, v3}, Landroid/support/v4/view/bw;->c(Landroid/view/View;I)V
...
.method private static a(Landroid/view/View;II)V
    ...
    invoke-static {p0}, Landroid/support/v4/view/bw;->z(Landroid/view/View;)Z
    ...
    invoke-static {p0, v0, p1, v1, p2}, Landroid/support/v4/view/bw;->a(Landroid/view/View;IIII)V
...
.method a(II)V
    ...
    invoke-virtual {v0, v2, v3}, Landroid/support/v4/view/ei;->b(J)Landroid/support/v4/view/ei;
...
.method b(II)V
    ...
    invoke-static {v0, v4}, Landroid/support/v4/view/bw;->c(Landroid/view/View;F)V
...
.method protected onAttachedToWindow()V
    ...
    iget-object v0, p0, Landroid/support/design/widget/Snackbar$SnackbarLayout;->f:Landroid/support/design/widget/bi;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/design/widget/Snackbar$SnackbarLayout;->f:Landroid/support/design/widget/bi;

    invoke-interface {v0, p0}, Landroid/support/design/widget/bi;->a(Landroid/view/View;)V
...
.method protected onDetachedFromWindow()V
    ...
    invoke-interface {v0, p0}, Landroid/support/design/widget/bi;->b(Landroid/view/View;)V
...
.method protected onLayout(ZIIII)V
    ...
    iget-object v0, p0, Landroid/support/design/widget/Snackbar$SnackbarLayout;->e:Landroid/support/design/widget/bj;
    ...
    invoke-interface/range {v0 .. v5}, Landroid/support/design/widget/bj;->a(Landroid/view/View;IIII)V
...
.method setOnAttachStateChangeListener(Landroid/support/design/widget/bi;)V
    .locals 0

    iput-object p1, p0, Landroid/support/design/widget/Snackbar$SnackbarLayout;->f:Landroid/support/design/widget/bi;

    return-void
.end method

.method setOnLayoutChangeListener(Landroid/support/design/widget/bj;)V
    .locals 0

    iput-object p1, p0, Landroid/support/design/widget/Snackbar$SnackbarLayout;->e:Landroid/support/design/widget/bj;
