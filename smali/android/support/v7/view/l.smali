...
.field private d:Landroid/support/v4/view/ez;

.field private e:Z

.field private final f:Landroid/support/v4/view/fa;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/v7/view/l;->f:Landroid/support/v4/view/fa;
...
.method static synthetic a(Landroid/support/v7/view/l;)Landroid/support/v4/view/ez;
    .locals 1

    iget-object v0, p0, Landroid/support/v7/view/l;->d:Landroid/support/v4/view/ez;
...
.method public a(Landroid/support/v4/view/ei;)Landroid/support/v7/view/l;
    .locals 1
...
.method public a(Landroid/support/v4/view/ei;Landroid/support/v4/view/ei;)Landroid/support/v7/view/l;
    .locals 2
    ...
    invoke-virtual {p1}, Landroid/support/v4/view/ei;->a()J

    move-result-wide v0

    invoke-virtual {p2, v0, v1}, Landroid/support/v4/view/ei;->b(J)Landroid/support/v4/view/ei;
...
.method public a(Landroid/support/v4/view/ez;)Landroid/support/v7/view/l;
    .locals 1
    ...
    iput-object p1, p0, Landroid/support/v7/view/l;->d:Landroid/support/v4/view/ez;
...
.method public a()V
    ...
    check-cast v0, Landroid/support/v4/view/ei;
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/view/ei;->a(Landroid/view/animation/Interpolator;)Landroid/support/v4/view/ei;

    :cond_2
    iget-object v2, p0, Landroid/support/v7/view/l;->d:Landroid/support/v4/view/ez;

    if-eqz v2, :cond_3

    iget-object v2, p0, Landroid/support/v7/view/l;->f:Landroid/support/v4/view/fa;
