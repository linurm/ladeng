...
.field private c:Landroid/support/v7/a/ae;
...
.method public a()V
    ...
    iget-object v0, p0, Landroid/support/v7/view/menu/l;->c:Landroid/support/v7/a/ae;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/view/menu/l;->c:Landroid/support/v7/a/ae;

    invoke-virtual {v0}, Landroid/support/v7/a/ae;->dismiss()V
...
.method public a(Landroid/os/IBinder;)V
    ...
    new-instance v1, Landroid/support/v7/a/af;

    invoke-virtual {v0}, Landroid/support/v7/view/menu/i;->e()Landroid/content/Context;

    move-result-object v2

    invoke-direct {v1, v2}, Landroid/support/v7/a/af;-><init>(Landroid/content/Context;)V

    new-instance v2, Landroid/support/v7/view/menu/g;

    invoke-virtual {v1}, Landroid/support/v7/a/af;->a()Landroid/content/Context;
    ...
    invoke-virtual {v1, v2, p0}, Landroid/support/v7/a/af;->a(Landroid/widget/ListAdapter;Landroid/content/DialogInterface$OnClickListener;)Landroid/support/v7/a/af;
    ...
    invoke-virtual {v1, v2}, Landroid/support/v7/a/af;->a(Landroid/view/View;)Landroid/support/v7/a/af;

    :goto_0
    invoke-virtual {v1, p0}, Landroid/support/v7/a/af;->a(Landroid/content/DialogInterface$OnKeyListener;)Landroid/support/v7/a/af;

    invoke-virtual {v1}, Landroid/support/v7/a/af;->b()Landroid/support/v7/a/ae;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/view/menu/l;->c:Landroid/support/v7/a/ae;

    iget-object v0, p0, Landroid/support/v7/view/menu/l;->c:Landroid/support/v7/a/ae;

    invoke-virtual {v0, p0}, Landroid/support/v7/a/ae;->setOnDismissListener(Landroid/content/DialogInterface$OnDismissListener;)V

    iget-object v0, p0, Landroid/support/v7/view/menu/l;->c:Landroid/support/v7/a/ae;

    invoke-virtual {v0}, Landroid/support/v7/a/ae;->getWindow()Landroid/view/Window;
    ...
    invoke-virtual {v0}, Landroid/support/v7/a/ae;->show()V
    ...
    invoke-virtual {v1, v2}, Landroid/support/v7/a/af;->a(Landroid/graphics/drawable/Drawable;)Landroid/support/v7/a/af;
    ...
    invoke-virtual {v2, v0}, Landroid/support/v7/a/af;->a(Ljava/lang/CharSequence;)Landroid/support/v7/a/af;
...
.method public onDismiss(Landroid/content/DialogInterface;)V
    ...
    invoke-virtual {v0, v1, v2}, Landroid/support/v7/view/menu/g;->a(Landroid/support/v7/view/menu/i;Z)V
...
.method public onKey(Landroid/content/DialogInterface;ILandroid/view/KeyEvent;)Z
    ...
    iget-object v1, p0, Landroid/support/v7/view/menu/l;->c:Landroid/support/v7/a/ae;

    invoke-virtual {v1}, Landroid/support/v7/a/ae;->getWindow()Landroid/view/Window;
    ...
    invoke-virtual {v1, v0}, Landroid/support/v7/view/menu/i;->a(Z)V
