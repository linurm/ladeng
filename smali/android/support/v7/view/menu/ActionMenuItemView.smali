...
.field private e:Landroid/support/v7/widget/dc;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {p0, p1, p2, p3}, Landroid/support/v7/widget/br;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method static synthetic b(Landroid/support/v7/view/menu/ActionMenuItemView;)Landroid/support/v7/view/menu/k;
    .locals 1

    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->d:Landroid/support/v7/view/menu/k;

    return-object v0
.end method

.method static synthetic c(Landroid/support/v7/view/menu/ActionMenuItemView;)Landroid/support/v7/view/menu/m;
    .locals 1
...
.method private e()V
    ...
    invoke-virtual {v3}, Landroid/support/v7/view/menu/m;->m()Z
...
.method public a(Landroid/support/v7/view/menu/m;I)V
    ...
    invoke-virtual {p1, p0}, Landroid/support/v7/view/menu/m;->a(Landroid/support/v7/view/menu/aa;)Ljava/lang/CharSequence;
    ...
    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->e:Landroid/support/v7/widget/dc;
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->e:Landroid/support/v7/widget/dc;
...
.method public onClick(Landroid/view/View;)V
    ...
    iget-object v1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->a:Landroid/support/v7/view/menu/m;

    invoke-interface {v0, v1}, Landroid/support/v7/view/menu/k;->a(Landroid/support/v7/view/menu/m;)Z
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-super {p0, p1}, Landroid/support/v7/widget/br;->onConfigurationChanged(Landroid/content/res/Configuration;)V
...
.method protected onMeasure(II)V
    ...
    invoke-super {p0, v0, v2, v3, v4}, Landroid/support/v7/widget/br;->setPadding(IIII)V

    :cond_0
    invoke-super {p0, p1, p2}, Landroid/support/v7/widget/br;->onMeasure(II)V
    ...
    invoke-super {p0, v0, p2}, Landroid/support/v7/widget/br;->onMeasure(II)V
    ...
    invoke-super {p0, v0, v1, v2, v3}, Landroid/support/v7/widget/br;->setPadding(IIII)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    :cond_0
    invoke-super {p0, p1}, Landroid/support/v7/widget/br;->onTouchEvent(Landroid/view/MotionEvent;)Z
...
.method public setExpandedFormat(Z)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/view/menu/m;->h()V
...
.method public setItemInvoker(Landroid/support/v7/view/menu/k;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->d:Landroid/support/v7/view/menu/k;
...
.method public setPadding(IIII)V
    ...
    invoke-super {p0, p1, p2, p3, p4}, Landroid/support/v7/widget/br;->setPadding(IIII)V
