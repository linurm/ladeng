...
.field protected c:Landroid/support/v7/view/menu/i;

.field protected d:Landroid/view/LayoutInflater;

.field protected e:Landroid/view/LayoutInflater;

.field protected f:Landroid/support/v7/view/menu/z;

.field private g:Landroid/support/v7/view/menu/y;
...
# virtual methods
.method public a()Landroid/support/v7/view/menu/y;
    .locals 1

    iget-object v0, p0, Landroid/support/v7/view/menu/d;->g:Landroid/support/v7/view/menu/y;
...
.method public a(Landroid/view/ViewGroup;)Landroid/support/v7/view/menu/z;
    ...
    iget-object v0, p0, Landroid/support/v7/view/menu/d;->f:Landroid/support/v7/view/menu/z;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/view/menu/d;->d:Landroid/view/LayoutInflater;

    iget v1, p0, Landroid/support/v7/view/menu/d;->h:I
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/d;->f:Landroid/support/v7/view/menu/z;

    iget-object v0, p0, Landroid/support/v7/view/menu/d;->f:Landroid/support/v7/view/menu/z;

    iget-object v1, p0, Landroid/support/v7/view/menu/d;->c:Landroid/support/v7/view/menu/i;

    invoke-interface {v0, v1}, Landroid/support/v7/view/menu/z;->a(Landroid/support/v7/view/menu/i;)V
...
.method public a(Landroid/support/v7/view/menu/m;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    instance-of v0, p2, Landroid/support/v7/view/menu/aa;

    if-eqz v0, :cond_0

    check-cast p2, Landroid/support/v7/view/menu/aa;

    move-object v0, p2

    :goto_0
    invoke-virtual {p0, p1, v0}, Landroid/support/v7/view/menu/d;->a(Landroid/support/v7/view/menu/m;Landroid/support/v7/view/menu/aa;)V
    ...
    :cond_0
    invoke-virtual {p0, p3}, Landroid/support/v7/view/menu/d;->b(Landroid/view/ViewGroup;)Landroid/support/v7/view/menu/aa;
...
.method public a(I)V
    ...
    iput p1, p0, Landroid/support/v7/view/menu/d;->j:I
...
.method public a(Landroid/content/Context;Landroid/support/v7/view/menu/i;)V
    ...
    iput-object p2, p0, Landroid/support/v7/view/menu/d;->c:Landroid/support/v7/view/menu/i;
...
.method public abstract a(Landroid/support/v7/view/menu/m;Landroid/support/v7/view/menu/aa;)V
.end method

.method public a(Landroid/support/v7/view/menu/y;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v7/view/menu/d;->g:Landroid/support/v7/view/menu/y;
...
.method public b(Landroid/view/ViewGroup;)Landroid/support/v7/view/menu/aa;
    .locals 3
...
.method public b(Z)V
    ...
    invoke-virtual {v1}, Landroid/support/v7/view/menu/i;->j()V
    ...
    invoke-virtual {p0, v4, v1}, Landroid/support/v7/view/menu/d;->a(ILandroid/support/v7/view/menu/m;)Z
    ...
    instance-of v2, v3, Landroid/support/v7/view/menu/aa;

    if-eqz v2, :cond_4

    move-object v2, v3

    check-cast v2, Landroid/support/v7/view/menu/aa;

    invoke-interface {v2}, Landroid/support/v7/view/menu/aa;->getItemData()Landroid/support/v7/view/menu/m;

    move-result-object v2

    :goto_1
    invoke-virtual {p0, v1, v3, v0}, Landroid/support/v7/view/menu/d;->a(Landroid/support/v7/view/menu/m;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    invoke-static {v9}, Landroid/support/v4/view/bw;->x(Landroid/view/View;)V
