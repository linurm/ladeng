...
.method public constructor <init>(Landroid/support/v7/view/menu/ActionMenuItemView;)V
    ...
    invoke-direct {p0, p1}, Landroid/support/v7/widget/dc;-><init>(Landroid/view/View;)V
...
.method public a()Landroid/support/v7/widget/cx;
    ...
    invoke-virtual {v0}, Landroid/support/v7/view/menu/c;->a()Landroid/support/v7/widget/cx;
...
.method protected b()Z
    ...
    invoke-interface {v1, v2}, Landroid/support/v7/view/menu/k;->a(Landroid/support/v7/view/menu/m;)Z

    move-result v1

    if-eqz v1, :cond_0

    invoke-virtual {p0}, Landroid/support/v7/view/menu/b;->a()Landroid/support/v7/widget/cx;

    move-result-object v1

    if-eqz v1, :cond_0

    invoke-virtual {v1}, Landroid/support/v7/widget/cx;->k()Z
