...
.field private l:Landroid/support/v7/widget/cx;
...
.method public c()Landroid/support/v7/widget/cx;
    .locals 1

    iget-object v0, p0, Landroid/support/v7/view/menu/v;->l:Landroid/support/v7/widget/cx;
...
.method public d()Z
    ...
    new-instance v2, Landroid/support/v7/widget/cx;
    ...
    invoke-direct {v2, v3, v4, v5, v6}, Landroid/support/v7/widget/cx;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    iput-object v2, p0, Landroid/support/v7/view/menu/v;->l:Landroid/support/v7/widget/cx;

    iget-object v2, p0, Landroid/support/v7/view/menu/v;->l:Landroid/support/v7/widget/cx;

    invoke-virtual {v2, p0}, Landroid/support/v7/widget/cx;->a(Landroid/widget/PopupWindow$OnDismissListener;)V

    iget-object v2, p0, Landroid/support/v7/view/menu/v;->l:Landroid/support/v7/widget/cx;

    invoke-virtual {v2, p0}, Landroid/support/v7/widget/cx;->a(Landroid/widget/AdapterView$OnItemClickListener;)V

    iget-object v2, p0, Landroid/support/v7/view/menu/v;->l:Landroid/support/v7/widget/cx;

    iget-object v3, p0, Landroid/support/v7/view/menu/v;->f:Landroid/support/v7/view/menu/w;

    invoke-virtual {v2, v3}, Landroid/support/v7/widget/cx;->a(Landroid/widget/ListAdapter;)V

    iget-object v2, p0, Landroid/support/v7/view/menu/v;->l:Landroid/support/v7/widget/cx;

    invoke-virtual {v2, v1}, Landroid/support/v7/widget/cx;->a(Z)V
    ...
    invoke-virtual {v0, v2}, Landroid/support/v7/widget/cx;->d(I)V
    ...
    invoke-virtual {v0, v2}, Landroid/support/v7/widget/cx;->f(I)V

    iget-object v0, p0, Landroid/support/v7/view/menu/v;->l:Landroid/support/v7/widget/cx;

    const/4 v2, 0x2

    invoke-virtual {v0, v2}, Landroid/support/v7/widget/cx;->g(I)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/cx;->m()Landroid/widget/ListView;
...
.method public onDismiss()V
    ...
    iput-object v1, p0, Landroid/support/v7/view/menu/v;->l:Landroid/support/v7/widget/cx;
