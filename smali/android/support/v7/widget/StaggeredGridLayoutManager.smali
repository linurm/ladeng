...
.field private h:[Landroid/support/v7/widget/fs;

.field private i:I

.field private j:I

.field private k:Landroid/support/v7/widget/cq;
...
.field private final x:Landroid/support/v7/widget/fo;
...
.method public constructor <init>(II)V
    ...
    invoke-direct {v2, p0, v3}, Landroid/support/v7/widget/fo;-><init>(Landroid/support/v7/widget/StaggeredGridLayoutManager;Landroid/support/v7/widget/fn;)V

    iput-object v2, p0, Landroid/support/v7/widget/StaggeredGridLayoutManager;->x:Landroid/support/v7/widget/fo;
    ...
    new-instance v2, Landroid/support/v7/widget/fn;

    invoke-direct {v2, p0}, Landroid/support/v7/widget/fn;-><init>(Landroid/support/v7/widget/StaggeredGridLayoutManager;)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    invoke-static {p1, p2, p3, p4}, Landroid/support/v7/widget/StaggeredGridLayoutManager;->a(Landroid/content/Context;Landroid/util/AttributeSet;II)Landroid/support/v7/widget/ei;

    move-result-object v2

    iget v3, v2, Landroid/support/v7/widget/ei;->a:I

    invoke-virtual {p0, v3}, Landroid/support/v7/widget/StaggeredGridLayoutManager;->b(I)V

    iget v3, v2, Landroid/support/v7/widget/ei;->b:I

    invoke-virtual {p0, v3}, Landroid/support/v7/widget/StaggeredGridLayoutManager;->a(I)V

    iget-boolean v2, v2, Landroid/support/v7/widget/ei;->c:Z
...
.method private I()V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/StaggeredGridLayoutManager;->k:Landroid/support/v7/widget/cq;
...
.method private K()V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/StaggeredGridLayoutManager;->b:Landroid/support/v7/widget/do;
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/fp;->a()Z
    ...
    invoke-virtual {v1}, Landroid/support/v7/widget/do;->h()I
    ...
    invoke-virtual {v1}, Landroid/support/v7/widget/do;->f()I
    ...
    iget-boolean v3, v0, Landroid/support/v7/widget/fp;->f:Z
    ...
    iget-object v6, v0, Landroid/support/v7/widget/fp;->e:Landroid/support/v7/widget/fs;

    iget v6, v6, Landroid/support/v7/widget/fs;->d:I
    ...
    iget-object v0, v0, Landroid/support/v7/widget/fp;->e:Landroid/support/v7/widget/fs;
    ...
    :cond_6
    iget-object v3, v0, Landroid/support/v7/widget/fp;->e:Landroid/support/v7/widget/fs;

    iget v3, v3, Landroid/support/v7/widget/fs;->d:I
...
.method private a(Landroid/support/v7/widget/eo;Landroid/support/v7/widget/cq;Landroid/support/v7/widget/eu;)I
    .locals 18
    ...
    iget-object v2, v0, Landroid/support/v7/widget/StaggeredGridLayoutManager;->k:Landroid/support/v7/widget/cq;

    iget-boolean v2, v2, Landroid/support/v7/widget/cq;->i:Z

    if-eqz v2, :cond_4

    move-object/from16 v0, p2

    iget v2, v0, Landroid/support/v7/widget/cq;->e:I
    ...
    :goto_2
    invoke-virtual/range {p2 .. p3}, Landroid/support/v7/widget/cq;->a(Landroid/support/v7/widget/eu;)Z
    ...
    iget-object v3, v0, Landroid/support/v7/widget/StaggeredGridLayoutManager;->k:Landroid/support/v7/widget/cq;

    iget-boolean v3, v3, Landroid/support/v7/widget/cq;->i:Z
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/cq;->a(Landroid/support/v7/widget/eo;)Landroid/view/View;
    ...
    check-cast v14, Landroid/support/v7/widget/fp;

    invoke-virtual {v14}, Landroid/support/v7/widget/fp;->e()I
    ...
    iget-boolean v2, v14, Landroid/support/v7/widget/fp;->f:Z

    if-eqz v2, :cond_8

    move-object/from16 v0, p0

    iget-object v2, v0, Landroid/support/v7/widget/StaggeredGridLayoutManager;->h:[Landroid/support/v7/widget/fs;
    ...
    invoke-virtual {v5, v6, v2}, Landroid/support/v7/widget/StaggeredGridLayoutManager$LazySpanLookup;->a(ILandroid/support/v7/widget/fs;)V
    ...
    iput-object v0, v14, Landroid/support/v7/widget/fp;->e:Landroid/support/v7/widget/fs;
    ...
    invoke-direct {v0, v3, v14, v2}, Landroid/support/v7/widget/StaggeredGridLayoutManager;->a(Landroid/view/View;Landroid/support/v7/widget/fp;Z)V
    ...
    iget-object v5, v0, Landroid/support/v7/widget/StaggeredGridLayoutManager;->a:Landroid/support/v7/widget/do;

    invoke-virtual {v5, v3}, Landroid/support/v7/widget/do;->c(Landroid/view/View;)I
    ...
    iget-boolean v5, v14, Landroid/support/v7/widget/fp;->f:Z
    ...
    iget v2, v0, Landroid/support/v7/widget/cq;->d:I
    ...
    invoke-direct {v0, v3, v14, v1}, Landroid/support/v7/widget/StaggeredGridLayoutManager;->a(Landroid/view/View;Landroid/support/v7/widget/fp;Landroid/support/v7/widget/cq;)V
    ...
    iget-object v2, v0, Landroid/support/v7/widget/StaggeredGridLayoutManager;->b:Landroid/support/v7/widget/do;
    ...
    iget-object v4, v0, Landroid/support/v7/widget/StaggeredGridLayoutManager;->b:Landroid/support/v7/widget/do;

    invoke-virtual {v4, v3}, Landroid/support/v7/widget/do;->c(Landroid/view/View;)I
    ...
    iget v2, v2, Landroid/support/v7/widget/cq;->e:I
    ...
    invoke-direct {v0, v1, v2}, Landroid/support/v7/widget/StaggeredGridLayoutManager;->a(Landroid/support/v7/widget/eo;Landroid/support/v7/widget/cq;)V

    move-object/from16 v0, p0

    iget-object v2, v0, Landroid/support/v7/widget/StaggeredGridLayoutManager;->k:Landroid/support/v7/widget/cq;

    iget-boolean v2, v2, Landroid/support/v7/widget/cq;->h:Z
    ...
    iget v2, v0, Landroid/support/v7/widget/cq;->g:I

    move-object/from16 v0, p2

    iget v3, v0, Landroid/support/v7/widget/cq;->b:I
    ...
    iget v2, v0, Landroid/support/v7/widget/cq;->f:I
    ...
    invoke-direct {v0, v1}, Landroid/support/v7/widget/StaggeredGridLayoutManager;->a(Landroid/support/v7/widget/cq;)Landroid/support/v7/widget/fs;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/fs;->b(I)I
    ...
    iget-boolean v7, v14, Landroid/support/v7/widget/fp;->f:Z
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/fs;->a(I)I
    ...
    iget v6, v0, Landroid/support/v7/widget/fs;->d:I
    ...
    iget v2, v0, Landroid/support/v7/widget/fs;->d:I
    ...
    invoke-direct {v0, v1, v2, v15}, Landroid/support/v7/widget/StaggeredGridLayoutManager;->a(Landroid/support/v7/widget/fs;II)V
    ...
    iget v3, v0, Landroid/support/v7/widget/fs;->d:I
...
.method private a(Landroid/support/v7/widget/eu;)I
    .locals 7
...
.method private a(Landroid/support/v7/widget/cq;)Landroid/support/v7/widget/fs;
    .locals 8
    ...
    iget v2, p1, Landroid/support/v7/widget/cq;->e:I
    ...
    :goto_0
    iget v4, p1, Landroid/support/v7/widget/cq;->e:I
    ...
    iget-object v1, p0, Landroid/support/v7/widget/StaggeredGridLayoutManager;->h:[Landroid/support/v7/widget/fs;

    aget-object v4, v1, v6

    invoke-virtual {v4, v7}, Landroid/support/v7/widget/fs;->b(I)I
    ...
    invoke-virtual {v4, v7}, Landroid/support/v7/widget/fs;->a(I)I
...
.method private a(ILandroid/support/v7/widget/eu;)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/StaggeredGridLayoutManager;->k:Landroid/support/v7/widget/cq;

    iput v1, v0, Landroid/support/v7/widget/cq;->b:I

    iget-object v0, p0, Landroid/support/v7/widget/StaggeredGridLayoutManager;->k:Landroid/support/v7/widget/cq;

    iput p1, v0, Landroid/support/v7/widget/cq;->c:I
    ...
    invoke-virtual {p2}, Landroid/support/v7/widget/eu;->c()I
    ...
    iget-object v4, p0, Landroid/support/v7/widget/StaggeredGridLayoutManager;->k:Landroid/support/v7/widget/cq;
    ...
    iput v2, v4, Landroid/support/v7/widget/cq;->f:I

    iget-object v2, p0, Landroid/support/v7/widget/StaggeredGridLayoutManager;->k:Landroid/support/v7/widget/cq;
    ...
    iput v0, v2, Landroid/support/v7/widget/cq;->g:I

    :goto_2
    iget-object v0, p0, Landroid/support/v7/widget/StaggeredGridLayoutManager;->k:Landroid/support/v7/widget/cq;

    iput-boolean v1, v0, Landroid/support/v7/widget/cq;->h:Z

    iget-object v0, p0, Landroid/support/v7/widget/StaggeredGridLayoutManager;->k:Landroid/support/v7/widget/cq;

    iput-boolean v3, v0, Landroid/support/v7/widget/cq;->a:Z
    ...
    :cond_0
    iput-boolean v1, v0, Landroid/support/v7/widget/cq;->i:Z
    ...
    invoke-virtual {v5}, Landroid/support/v7/widget/do;->e()I

    move-result v5

    add-int/2addr v0, v5

    iput v0, v4, Landroid/support/v7/widget/cq;->g:I

    iget-object v0, p0, Landroid/support/v7/widget/StaggeredGridLayoutManager;->k:Landroid/support/v7/widget/cq;

    neg-int v2, v2

    iput v2, v0, Landroid/support/v7/widget/cq;->f:I
...
.method private a(Landroid/support/v7/widget/eo;I)V
    ...
    iget-object v3, p0, Landroid/support/v7/widget/StaggeredGridLayoutManager;->h:[Landroid/support/v7/widget/fs;

    aget-object v3, v3, v0

    invoke-static {v3}, Landroid/support/v7/widget/fs;->a(Landroid/support/v7/widget/fs;)Ljava/util/ArrayList;
    ...
    invoke-virtual {v3}, Landroid/support/v7/widget/fs;->h()V
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/fs;->h()V
...
.method private a(Landroid/support/v7/widget/eo;Landroid/support/v7/widget/cq;)V
    .locals 3

    const/4 v1, -0x1

    iget-boolean v0, p2, Landroid/support/v7/widget/cq;->a:Z

    if-eqz v0, :cond_0

    iget-boolean v0, p2, Landroid/support/v7/widget/cq;->i:Z
    ...
    :cond_1
    iget v0, p2, Landroid/support/v7/widget/cq;->b:I

    if-nez v0, :cond_3

    iget v0, p2, Landroid/support/v7/widget/cq;->e:I

    if-ne v0, v1, :cond_2

    iget v0, p2, Landroid/support/v7/widget/cq;->g:I
    ...
    :cond_2
    iget v0, p2, Landroid/support/v7/widget/cq;->f:I
    ...
    iget v1, p2, Landroid/support/v7/widget/cq;->f:I
    ...
    :cond_4
    iget v1, p2, Landroid/support/v7/widget/cq;->g:I

    iget v2, p2, Landroid/support/v7/widget/cq;->b:I
...
.method private a(Landroid/support/v7/widget/eo;Landroid/support/v7/widget/eu;Z)V
    ...
    iget-object v3, p0, Landroid/support/v7/widget/StaggeredGridLayoutManager;->x:Landroid/support/v7/widget/fo;

    invoke-virtual {v3}, Landroid/support/v7/widget/fo;->a()V
    ...
    invoke-direct {p0, v3}, Landroid/support/v7/widget/StaggeredGridLayoutManager;->a(Landroid/support/v7/widget/fo;)V

    :goto_1
    invoke-virtual {p0, p2, v3}, Landroid/support/v7/widget/StaggeredGridLayoutManager;->a(Landroid/support/v7/widget/eu;Landroid/support/v7/widget/fo;)V

    iget-object v0, p0, Landroid/support/v7/widget/StaggeredGridLayoutManager;->u:Landroid/support/v7/widget/StaggeredGridLayoutManager$SavedState;

    if-nez v0, :cond_4

    iget-boolean v0, v3, Landroid/support/v7/widget/fo;->c:Z
    ...
    iput-boolean v2, v3, Landroid/support/v7/widget/fo;->d:Z
    ...
    :cond_5
    iget-boolean v0, v3, Landroid/support/v7/widget/fo;->d:Z
    ...
    iget-object v4, p0, Landroid/support/v7/widget/StaggeredGridLayoutManager;->h:[Landroid/support/v7/widget/fs;

    aget-object v4, v4, v0

    invoke-virtual {v4}, Landroid/support/v7/widget/fs;->e()V

    iget v4, v3, Landroid/support/v7/widget/fo;->b:I
    ...
    iget v5, v3, Landroid/support/v7/widget/fo;->b:I

    invoke-virtual {v4, v5}, Landroid/support/v7/widget/fs;->c(I)V
    ...
    iput-boolean v0, v3, Landroid/support/v7/widget/fo;->c:Z
    ...
    iget v6, v3, Landroid/support/v7/widget/fo;->b:I

    invoke-virtual {v4, v5, v6}, Landroid/support/v7/widget/fs;->a(ZI)V
    ...
    iput-boolean v1, v0, Landroid/support/v7/widget/cq;->a:Z
    ...
    iget v0, v3, Landroid/support/v7/widget/fo;->a:I
    ...
    invoke-direct {p0, p1, v0, p2}, Landroid/support/v7/widget/StaggeredGridLayoutManager;->a(Landroid/support/v7/widget/eo;Landroid/support/v7/widget/cq;Landroid/support/v7/widget/eu;)I

    invoke-direct {p0, v2}, Landroid/support/v7/widget/StaggeredGridLayoutManager;->l(I)V

    iget-object v0, p0, Landroid/support/v7/widget/StaggeredGridLayoutManager;->k:Landroid/support/v7/widget/cq;

    iget v4, v3, Landroid/support/v7/widget/fo;->a:I

    iget-object v5, p0, Landroid/support/v7/widget/StaggeredGridLayoutManager;->k:Landroid/support/v7/widget/cq;

    iget v5, v5, Landroid/support/v7/widget/cq;->d:I

    add-int/2addr v4, v5

    iput v4, v0, Landroid/support/v7/widget/cq;->c:I
    ...
    invoke-direct {p0, p1, p2, v2}, Landroid/support/v7/widget/StaggeredGridLayoutManager;->b(Landroid/support/v7/widget/eo;Landroid/support/v7/widget/eu;Z)V

    invoke-direct {p0, p1, p2, v1}, Landroid/support/v7/widget/StaggeredGridLayoutManager;->c(Landroid/support/v7/widget/eo;Landroid/support/v7/widget/eu;Z)V
    ...
    :goto_8
    iget-boolean v2, v3, Landroid/support/v7/widget/fo;->c:Z
    ...
    invoke-direct {p0, p1, p2, v1}, Landroid/support/v7/widget/StaggeredGridLayoutManager;->a(Landroid/support/v7/widget/eo;Landroid/support/v7/widget/eu;Z)V
    ...
    :cond_d
    invoke-direct {p0, p1, p2, v2}, Landroid/support/v7/widget/StaggeredGridLayoutManager;->c(Landroid/support/v7/widget/eo;Landroid/support/v7/widget/eu;Z)V

    invoke-direct {p0, p1, p2, v1}, Landroid/support/v7/widget/StaggeredGridLayoutManager;->b(Landroid/support/v7/widget/eo;Landroid/support/v7/widget/eu;Z)V
...
.method private a(Landroid/support/v7/widget/fo;)V
    .locals 3
    ...
    invoke-virtual {v1}, Landroid/support/v7/widget/fs;->e()V
    ...
    :cond_0
    :goto_1
    iget-object v2, p0, Landroid/support/v7/widget/StaggeredGridLayoutManager;->h:[Landroid/support/v7/widget/fs;

    aget-object v2, v2, v0

    invoke-virtual {v2, v1}, Landroid/support/v7/widget/fs;->c(I)V
    ...
    iput-boolean v0, p1, Landroid/support/v7/widget/fo;->c:Z
...
.method private a(Landroid/support/v7/widget/fs;II)V
    .locals 3

    const/4 v2, 0x0

    invoke-virtual {p1}, Landroid/support/v7/widget/fs;->i()I
    ...
    invoke-virtual {p1}, Landroid/support/v7/widget/fs;->b()I
    ...
    iget v1, p1, Landroid/support/v7/widget/fs;->d:I
    ...
    :cond_1
    invoke-virtual {p1}, Landroid/support/v7/widget/fs;->d()I
...
.method private a(Landroid/view/View;IIZ)V
    ...
    iget v1, v0, Landroid/support/v7/widget/fp;->leftMargin:I
    ...
    iget v2, v0, Landroid/support/v7/widget/fp;->rightMargin:I
    ...
    iget v2, v0, Landroid/support/v7/widget/fp;->topMargin:I
    ...
    iget v3, v0, Landroid/support/v7/widget/fp;->bottomMargin:I
    ...
    invoke-virtual {p0, p1, v1, v2, v0}, Landroid/support/v7/widget/StaggeredGridLayoutManager;->a(Landroid/view/View;IILandroid/support/v7/widget/ej;)Z
    ...
    :cond_1
    invoke-virtual {p0, p1, v1, v2, v0}, Landroid/support/v7/widget/StaggeredGridLayoutManager;->b(Landroid/view/View;IILandroid/support/v7/widget/ej;)Z
...
.method private a(Landroid/view/View;Landroid/support/v7/widget/fp;Landroid/support/v7/widget/cq;)V
    .locals 2

    iget v0, p3, Landroid/support/v7/widget/cq;->e:I

    const/4 v1, 0x1

    if-ne v0, v1, :cond_1

    iget-boolean v0, p2, Landroid/support/v7/widget/fp;->f:Z
    ...
    :cond_0
    iget-object v0, p2, Landroid/support/v7/widget/fp;->e:Landroid/support/v7/widget/fs;

    invoke-virtual {v0, p1}, Landroid/support/v7/widget/fs;->b(Landroid/view/View;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/fs;->a(Landroid/view/View;)V

    goto :goto_0
.end method

.method private a(Landroid/view/View;Landroid/support/v7/widget/fp;Z)V
    .locals 6
    ...
    iget v3, p2, Landroid/support/v7/widget/fp;->height:I
    ...
    iget v2, p2, Landroid/support/v7/widget/fp;->width:I
...
.method private a(Landroid/support/v7/widget/fs;)Z
    .locals 4
    ...
    invoke-static {p1}, Landroid/support/v7/widget/fs;->a(Landroid/support/v7/widget/fs;)Ljava/util/ArrayList;
    ...
    invoke-virtual {p1, v0}, Landroid/support/v7/widget/fs;->c(Landroid/view/View;)Landroid/support/v7/widget/fp;

    move-result-object v0

    iget-boolean v0, v0, Landroid/support/v7/widget/fp;->f:Z
...
.method private b(Landroid/support/v7/widget/eo;I)V
    ...
    iget-boolean v4, v0, Landroid/support/v7/widget/fp;->f:Z
    ...
    invoke-static {v4}, Landroid/support/v7/widget/fs;->a(Landroid/support/v7/widget/fs;)Ljava/util/ArrayList;
    ...
    invoke-virtual {v4}, Landroid/support/v7/widget/fs;->g()V
    ...
    :cond_3
    iget-object v4, v0, Landroid/support/v7/widget/fp;->e:Landroid/support/v7/widget/fs;
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/fs;->g()V
...
.method private b(Landroid/support/v7/widget/eo;Landroid/support/v7/widget/eu;Z)V
    ...
    invoke-virtual {p0, v1, p1, p2}, Landroid/support/v7/widget/StaggeredGridLayoutManager;->c(ILandroid/support/v7/widget/eo;Landroid/support/v7/widget/eu;)I
...
.method private b(Landroid/view/View;IIII)V
    ...
    iget v1, v0, Landroid/support/v7/widget/fp;->topMargin:I

    add-int v3, p3, v1

    iget v1, v0, Landroid/support/v7/widget/fp;->rightMargin:I

    sub-int v4, p4, v1

    iget v0, v0, Landroid/support/v7/widget/fp;->bottomMargin:I
...
.method private c(Landroid/support/v7/widget/eo;Landroid/support/v7/widget/eu;Z)V
    .locals 2
    ...
    invoke-virtual {p0, v0, p1, p2}, Landroid/support/v7/widget/StaggeredGridLayoutManager;->c(ILandroid/support/v7/widget/eo;Landroid/support/v7/widget/eu;)I
...
.method private c(Landroid/support/v7/widget/eu;Landroid/support/v7/widget/fo;)Z
    .locals 1
    ...
    :goto_0
    iput v0, p2, Landroid/support/v7/widget/fo;->a:I

    const/high16 v0, -0x80000000

    iput v0, p2, Landroid/support/v7/widget/fo;->b:I
...
.method private e(II)V
    ...
    invoke-static {v1}, Landroid/support/v7/widget/fs;->a(Landroid/support/v7/widget/fs;)Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v1, p1, p2}, Landroid/support/v7/widget/StaggeredGridLayoutManager;->a(Landroid/support/v7/widget/fs;II)V
...
.method private l(I)V
    ...
    iput p1, v2, Landroid/support/v7/widget/cq;->e:I

    iget-object v3, p0, Landroid/support/v7/widget/StaggeredGridLayoutManager;->k:Landroid/support/v7/widget/cq;
    ...
    :goto_1
    iput v0, v3, Landroid/support/v7/widget/cq;->d:I
...
.method private m(I)Landroid/support/v7/widget/StaggeredGridLayoutManager$LazySpanLookup$FullSpanItem;
    ...
    invoke-virtual {v3, p1}, Landroid/support/v7/widget/fs;->b(I)I
...
.method private n(I)Landroid/support/v7/widget/StaggeredGridLayoutManager$LazySpanLookup$FullSpanItem;
    ...
    invoke-virtual {v3, p1}, Landroid/support/v7/widget/fs;->a(I)I
...
.method private o(I)I
    ...
    iget-object v0, p0, Landroid/support/v7/widget/StaggeredGridLayoutManager;->h:[Landroid/support/v7/widget/fs;

    const/4 v1, 0x0

    aget-object v0, v0, v1

    invoke-virtual {v0, p1}, Landroid/support/v7/widget/fs;->a(I)I
    ...
    invoke-virtual {v2, p1}, Landroid/support/v7/widget/fs;->a(I)I
...
.method private p(Landroid/view/View;)V
    ...
    invoke-virtual {v1, p1}, Landroid/support/v7/widget/fs;->b(Landroid/view/View;)V
...
.method private q(I)I
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/fs;->b(I)I
    ...
    invoke-virtual {v2, p1}, Landroid/support/v7/widget/fs;->b(I)I
...
.method private q(Landroid/view/View;)V
    ...
    invoke-virtual {v1, p1}, Landroid/support/v7/widget/fs;->a(Landroid/view/View;)V
...
.method public a(ILandroid/support/v7/widget/eo;Landroid/support/v7/widget/eu;)I
    ...
    invoke-virtual {p0, p1, p2, p3}, Landroid/support/v7/widget/StaggeredGridLayoutManager;->c(ILandroid/support/v7/widget/eo;Landroid/support/v7/widget/eu;)I
...
.method public a(Landroid/support/v7/widget/eo;Landroid/support/v7/widget/eu;)I
    ...
    :cond_0
    invoke-super {p0, p1, p2}, Landroid/support/v7/widget/eh;->a(Landroid/support/v7/widget/eo;Landroid/support/v7/widget/eu;)I
...
.method public a()Landroid/support/v7/widget/ej;
    ...
    invoke-direct {v0, v1, v2}, Landroid/support/v7/widget/fp;-><init>(II)V
    ...
    invoke-direct {v0, v2, v1}, Landroid/support/v7/widget/fp;-><init>(II)V

    goto :goto_0
.end method

.method public a(Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/support/v7/widget/ej;
    .locals 1

    new-instance v0, Landroid/support/v7/widget/fp;

    invoke-direct {v0, p1, p2}, Landroid/support/v7/widget/fp;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    return-object v0
.end method

.method public a(Landroid/view/ViewGroup$LayoutParams;)Landroid/support/v7/widget/ej;
    .locals 1
    ...
    invoke-direct {v0, p1}, Landroid/support/v7/widget/fp;-><init>(Landroid/view/ViewGroup$MarginLayoutParams;)V
    ...
    invoke-direct {v0, p1}, Landroid/support/v7/widget/fp;-><init>(Landroid/view/ViewGroup$LayoutParams;)V
...
.method public a(Landroid/view/View;ILandroid/support/v7/widget/eo;Landroid/support/v7/widget/eu;)Landroid/view/View;
    ...
    iget-object v7, p0, Landroid/support/v7/widget/StaggeredGridLayoutManager;->k:Landroid/support/v7/widget/cq;

    iget-object v8, p0, Landroid/support/v7/widget/StaggeredGridLayoutManager;->k:Landroid/support/v7/widget/cq;

    iget v8, v8, Landroid/support/v7/widget/cq;->d:I

    add-int/2addr v8, v0

    iput v8, v7, Landroid/support/v7/widget/cq;->c:I

    iget-object v7, p0, Landroid/support/v7/widget/StaggeredGridLayoutManager;->k:Landroid/support/v7/widget/cq;

    const v8, 0x3eaaaaab

    iget-object v9, p0, Landroid/support/v7/widget/StaggeredGridLayoutManager;->a:Landroid/support/v7/widget/do;

    invoke-virtual {v9}, Landroid/support/v7/widget/do;->f()I
    ...
    iput v8, v7, Landroid/support/v7/widget/cq;->b:I

    iget-object v7, p0, Landroid/support/v7/widget/StaggeredGridLayoutManager;->k:Landroid/support/v7/widget/cq;

    iput-boolean v10, v7, Landroid/support/v7/widget/cq;->h:Z

    iget-object v7, p0, Landroid/support/v7/widget/StaggeredGridLayoutManager;->k:Landroid/support/v7/widget/cq;

    iput-boolean v1, v7, Landroid/support/v7/widget/cq;->a:Z

    iget-object v7, p0, Landroid/support/v7/widget/StaggeredGridLayoutManager;->k:Landroid/support/v7/widget/cq;

    invoke-direct {p0, p3, v7, p4}, Landroid/support/v7/widget/StaggeredGridLayoutManager;->a(Landroid/support/v7/widget/eo;Landroid/support/v7/widget/cq;Landroid/support/v7/widget/eu;)I
    ...
    invoke-virtual {v6, v0, v5}, Landroid/support/v7/widget/fs;->a(II)Landroid/view/View;
    ...
    invoke-virtual {v1, v0, v5}, Landroid/support/v7/widget/fs;->a(II)Landroid/view/View;
    ...
    invoke-virtual {v3, v0, v5}, Landroid/support/v7/widget/fs;->a(II)Landroid/view/View;
...
.method a(ZZ)Landroid/view/View;
    ...
    invoke-virtual {v6, v1}, Landroid/support/v7/widget/do;->a(Landroid/view/View;)I

    move-result v6

    iget-object v7, p0, Landroid/support/v7/widget/StaggeredGridLayoutManager;->a:Landroid/support/v7/widget/do;

    invoke-virtual {v7, v1}, Landroid/support/v7/widget/do;->b(Landroid/view/View;)I
...
.method public a(I)V
    ...
    new-array v0, v0, [Landroid/support/v7/widget/fs;

    iput-object v0, p0, Landroid/support/v7/widget/StaggeredGridLayoutManager;->h:[Landroid/support/v7/widget/fs;
    ...
    new-instance v2, Landroid/support/v7/widget/fs;

    invoke-direct {v2, p0, v0, v3}, Landroid/support/v7/widget/fs;-><init>(Landroid/support/v7/widget/StaggeredGridLayoutManager;ILandroid/support/v7/widget/fn;)V
...
.method public a(Landroid/support/v7/widget/eo;Landroid/support/v7/widget/eu;Landroid/view/View;Landroid/support/v4/view/a/g;)V
    .locals 6
    ...
    instance-of v1, v0, Landroid/support/v7/widget/fp;

    if-nez v1, :cond_0

    invoke-super {p0, p3, p4}, Landroid/support/v7/widget/eh;->a(Landroid/view/View;Landroid/support/v4/view/a/g;)V
    ...
    check-cast v4, Landroid/support/v7/widget/fp;

    iget v0, p0, Landroid/support/v7/widget/StaggeredGridLayoutManager;->i:I

    if-nez v0, :cond_2

    invoke-virtual {v4}, Landroid/support/v7/widget/fp;->b()I

    move-result v0

    iget-boolean v1, v4, Landroid/support/v7/widget/fp;->f:Z
    ...
    iget-boolean v4, v4, Landroid/support/v7/widget/fp;->f:Z
    ...
    iget-boolean v3, v4, Landroid/support/v7/widget/fp;->f:Z
...
.method a(Landroid/support/v7/widget/eu;Landroid/support/v7/widget/fo;)V
    .locals 1

    invoke-virtual {p0, p1, p2}, Landroid/support/v7/widget/StaggeredGridLayoutManager;->b(Landroid/support/v7/widget/eu;Landroid/support/v7/widget/fo;)Z
    ...
    :cond_1
    invoke-direct {p0, p1, p2}, Landroid/support/v7/widget/StaggeredGridLayoutManager;->c(Landroid/support/v7/widget/eu;Landroid/support/v7/widget/fo;)Z

    move-result v0

    if-nez v0, :cond_0

    invoke-virtual {p2}, Landroid/support/v7/widget/fo;->b()V
...
.method public a(Landroid/view/accessibility/AccessibilityEvent;)V
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/view/a/al;->c(I)V

    goto :goto_0

    :cond_2
    invoke-virtual {v0, v2}, Landroid/support/v4/view/a/al;->b(I)V
...
.method public a(Landroid/support/v7/widget/ej;)Z
    .locals 1

    instance-of v0, p1, Landroid/support/v7/widget/fp;
...
.method public b(Landroid/support/v7/widget/eo;Landroid/support/v7/widget/eu;)I
    ...
    :cond_0
    invoke-super {p0, p1, p2}, Landroid/support/v7/widget/eh;->b(Landroid/support/v7/widget/eo;Landroid/support/v7/widget/eu;)I
...
.method public b(Landroid/support/v7/widget/eu;)I
    ...
    invoke-direct {p0, p1}, Landroid/support/v7/widget/StaggeredGridLayoutManager;->a(Landroid/support/v7/widget/eu;)I
...
.method public b(I)V
    ...
    iput-object v1, p0, Landroid/support/v7/widget/StaggeredGridLayoutManager;->a:Landroid/support/v7/widget/do;
...
.method b(Landroid/support/v7/widget/eu;Landroid/support/v7/widget/fo;)Z
    .locals 6
    ...
    iget-boolean v0, p2, Landroid/support/v7/widget/fo;->c:Z
    ...
    invoke-virtual {v3}, Landroid/support/v7/widget/do;->f()I
    ...
    :cond_b
    iput v4, p2, Landroid/support/v7/widget/fo;->b:I
    ...
    iput v2, p2, Landroid/support/v7/widget/fo;->a:I

    iget v2, p0, Landroid/support/v7/widget/StaggeredGridLayoutManager;->e:I

    if-ne v2, v4, :cond_e

    iget v2, p2, Landroid/support/v7/widget/fo;->a:I
    ...
    :cond_d
    iput-boolean v0, p2, Landroid/support/v7/widget/fo;->c:Z

    invoke-virtual {p2}, Landroid/support/v7/widget/fo;->b()V

    :goto_3
    iput-boolean v1, p2, Landroid/support/v7/widget/fo;->d:Z
    ...
    invoke-virtual {p2, v0}, Landroid/support/v7/widget/fo;->a(I)V
...
.method c(ILandroid/support/v7/widget/eo;Landroid/support/v7/widget/eu;)I
    ...
    iput-boolean v1, v3, Landroid/support/v7/widget/cq;->a:Z
    ...
    iget-object v1, p0, Landroid/support/v7/widget/StaggeredGridLayoutManager;->k:Landroid/support/v7/widget/cq;

    iget v1, v1, Landroid/support/v7/widget/cq;->d:I

    add-int/2addr v1, v2

    iput v1, v0, Landroid/support/v7/widget/cq;->c:I
    ...
    invoke-direct {p0, p2, v0, p3}, Landroid/support/v7/widget/StaggeredGridLayoutManager;->a(Landroid/support/v7/widget/eo;Landroid/support/v7/widget/cq;Landroid/support/v7/widget/eu;)I
...
.method public c()Landroid/os/Parcelable;
    ...
    invoke-virtual {v1, v4}, Landroid/support/v7/widget/fs;->b(I)I
    ...
    invoke-virtual {v1, v4}, Landroid/support/v7/widget/fs;->a(I)I
...
.method f()Landroid/view/View;
    ...
    iget-object v1, v0, Landroid/support/v7/widget/fp;->e:Landroid/support/v7/widget/fs;

    iget v1, v1, Landroid/support/v7/widget/fs;->d:I
    ...
    invoke-direct {p0, v1}, Landroid/support/v7/widget/StaggeredGridLayoutManager;->a(Landroid/support/v7/widget/fs;)Z
    ...
    :cond_4
    iget-boolean v1, v0, Landroid/support/v7/widget/fp;->f:Z
    ...
    check-cast v1, Landroid/support/v7/widget/fp;

    iget-object v0, v0, Landroid/support/v7/widget/fp;->e:Landroid/support/v7/widget/fs;

    iget v0, v0, Landroid/support/v7/widget/fs;->d:I

    iget-object v1, v1, Landroid/support/v7/widget/fp;->e:Landroid/support/v7/widget/fs;
...
.method public i(I)V
    ...
    invoke-super {p0, p1}, Landroid/support/v7/widget/eh;->i(I)V
    ...
    invoke-virtual {v1, p1}, Landroid/support/v7/widget/fs;->d(I)V
...
.method public j(I)V
    ...
    invoke-super {p0, p1}, Landroid/support/v7/widget/eh;->j(I)V
...
.method k()Z
    ...
    invoke-virtual {v0, v5}, Landroid/support/v7/widget/fs;->b(I)I
    ...
    invoke-virtual {v4, v5}, Landroid/support/v7/widget/fs;->b(I)I
...
.method l()Z
    ...
    invoke-virtual {v0, v5}, Landroid/support/v7/widget/fs;->a(I)I
    ...
    invoke-virtual {v4, v5}, Landroid/support/v7/widget/fs;->a(I)I
