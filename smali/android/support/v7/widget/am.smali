...
.method private c(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/am;->e:Landroid/support/v7/widget/fy;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/am;->e:Landroid/support/v7/widget/fy;
    ...
    invoke-static {v1}, Landroid/support/v4/view/bw;->A(Landroid/view/View;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {v1}, Landroid/support/v4/view/bw;->B(Landroid/view/View;)Landroid/graphics/PorterDuff$Mode;

    move-result-object v1

    if-eqz v1, :cond_2

    iput-boolean v2, v0, Landroid/support/v7/widget/fy;->c:Z

    iput-object v1, v0, Landroid/support/v7/widget/fy;->b:Landroid/graphics/PorterDuff$Mode;

    :cond_2
    iget-boolean v1, v0, Landroid/support/v7/widget/fy;->d:Z

    if-nez v1, :cond_3

    iget-boolean v1, v0, Landroid/support/v7/widget/fy;->c:Z
    ...
    invoke-static {p1, v0, v1}, Landroid/support/v7/widget/ar;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/fy;[I)V
...
.method a()Landroid/content/res/ColorStateList;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/am;->d:Landroid/support/v7/widget/fy;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/am;->d:Landroid/support/v7/widget/fy;

    iget-object v0, v0, Landroid/support/v7/widget/fy;->a:Landroid/content/res/ColorStateList;
...
.method a(Landroid/content/res/ColorStateList;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/am;->d:Landroid/support/v7/widget/fy;

    :cond_0
    iget-object v0, p0, Landroid/support/v7/widget/am;->d:Landroid/support/v7/widget/fy;

    iput-object p1, v0, Landroid/support/v7/widget/fy;->a:Landroid/content/res/ColorStateList;

    iget-object v0, p0, Landroid/support/v7/widget/am;->d:Landroid/support/v7/widget/fy;

    const/4 v1, 0x1

    iput-boolean v1, v0, Landroid/support/v7/widget/fy;->d:Z
...
.method a(Landroid/graphics/PorterDuff$Mode;)V
    ...
    iput-object p1, v0, Landroid/support/v7/widget/fy;->b:Landroid/graphics/PorterDuff$Mode;

    iget-object v0, p0, Landroid/support/v7/widget/am;->d:Landroid/support/v7/widget/fy;

    const/4 v1, 0x1

    iput-boolean v1, v0, Landroid/support/v7/widget/fy;->c:Z
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v2, v3}, Landroid/support/v7/widget/ck;->a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
...
.method b()Landroid/graphics/PorterDuff$Mode;
    ...
    iget-object v0, v0, Landroid/support/v7/widget/fy;->b:Landroid/graphics/PorterDuff$Mode;
...
.method b(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/am;->c:Landroid/support/v7/widget/fy;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/am;->c:Landroid/support/v7/widget/fy;
...
.method c()V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/am;->d:Landroid/support/v7/widget/fy;
    ...
    invoke-static {v0, v1, v2}, Landroid/support/v7/widget/ar;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/fy;[I)V
    ...
    :cond_1
    iget-object v1, p0, Landroid/support/v7/widget/am;->c:Landroid/support/v7/widget/fy;
