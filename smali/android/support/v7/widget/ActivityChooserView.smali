...
.field private final b:Landroid/support/v7/widget/ag;

.field private final c:Landroid/support/v7/widget/ah;

.field private final d:Landroid/support/v7/widget/cr;
...
.field private k:Landroid/support/v7/widget/cx;
...
# direct methods
.method static synthetic a(Landroid/support/v7/widget/ActivityChooserView;)Landroid/support/v7/widget/ag;
    .locals 1

    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->b:Landroid/support/v7/widget/ag;
...
.method private a(I)V
    ...
    :goto_0
    iget-object v3, p0, Landroid/support/v7/widget/ActivityChooserView;->b:Landroid/support/v7/widget/ag;
    ...
    invoke-virtual {v3, v1}, Landroid/support/v7/widget/ag;->a(Z)V

    iget-object v3, p0, Landroid/support/v7/widget/ActivityChooserView;->b:Landroid/support/v7/widget/ag;

    add-int/lit8 v4, p1, -0x1

    invoke-virtual {v3, v4}, Landroid/support/v7/widget/ag;->a(I)V

    :goto_2
    invoke-direct {p0}, Landroid/support/v7/widget/ActivityChooserView;->getListPopupWindow()Landroid/support/v7/widget/cx;
    ...
    :cond_1
    iget-object v2, p0, Landroid/support/v7/widget/ActivityChooserView;->b:Landroid/support/v7/widget/ag;

    invoke-virtual {v2, v1, v0}, Landroid/support/v7/widget/ag;->a(ZZ)V
    ...
    invoke-virtual {v3, v0}, Landroid/support/v7/widget/cx;->f(I)V

    invoke-virtual {v3}, Landroid/support/v7/widget/cx;->c()V
    ...
    :cond_2
    invoke-virtual {v3}, Landroid/support/v7/widget/cx;->m()Landroid/widget/ListView;
    ...
    invoke-virtual {v3, v2}, Landroid/support/v7/widget/ag;->a(Z)V

    iget-object v3, p0, Landroid/support/v7/widget/ActivityChooserView;->b:Landroid/support/v7/widget/ag;

    invoke-virtual {v3, p1}, Landroid/support/v7/widget/ag;->a(I)V
    ...
    invoke-virtual {v0, v2, v2}, Landroid/support/v7/widget/ag;->a(ZZ)V
...
.method private getListPopupWindow()Landroid/support/v7/widget/cx;
    .locals 2

    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->k:Landroid/support/v7/widget/cx;
    ...
    invoke-direct {v0, v1}, Landroid/support/v7/widget/cx;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->k:Landroid/support/v7/widget/cx;

    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->k:Landroid/support/v7/widget/cx;

    iget-object v1, p0, Landroid/support/v7/widget/ActivityChooserView;->b:Landroid/support/v7/widget/ag;

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/cx;->a(Landroid/widget/ListAdapter;)V

    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->k:Landroid/support/v7/widget/cx;

    invoke-virtual {v0, p0}, Landroid/support/v7/widget/cx;->a(Landroid/view/View;)V

    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->k:Landroid/support/v7/widget/cx;

    const/4 v1, 0x1

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/cx;->a(Z)V

    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->k:Landroid/support/v7/widget/cx;

    iget-object v1, p0, Landroid/support/v7/widget/ActivityChooserView;->c:Landroid/support/v7/widget/ah;

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/cx;->a(Landroid/widget/AdapterView$OnItemClickListener;)V

    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->k:Landroid/support/v7/widget/cx;

    iget-object v1, p0, Landroid/support/v7/widget/ActivityChooserView;->c:Landroid/support/v7/widget/ah;

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/cx;->a(Landroid/widget/PopupWindow$OnDismissListener;)V
...
.method public getDataModel()Landroid/support/v7/widget/z;
    .locals 1
...
.method protected onAttachedToWindow()V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/z;->registerObserver(Ljava/lang/Object;)V
...
.method protected onDetachedFromWindow()V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/z;->unregisterObserver(Ljava/lang/Object;)V
...
.method protected onLayout(ZIIII)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->d:Landroid/support/v7/widget/cr;

    sub-int v1, p4, p2

    sub-int v2, p5, p3

    invoke-virtual {v0, v3, v3, v1, v2}, Landroid/support/v7/widget/cr;->layout(IIII)V
...
.method public setActivityChooserModel(Landroid/support/v7/widget/z;)V
    .locals 1

    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->b:Landroid/support/v7/widget/ag;

    invoke-virtual {v0, p1}, Landroid/support/v7/widget/ag;->a(Landroid/support/v7/widget/z;)V
