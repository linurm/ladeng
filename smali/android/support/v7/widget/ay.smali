...
.method public constructor <init>(Landroid/widget/ImageView;Landroid/support/v7/widget/ar;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/ay;->a:Landroid/widget/ImageView;

    iput-object p2, p0, Landroid/support/v7/widget/ay;->b:Landroid/support/v7/widget/ar;
...
.method public a(I)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ay;->b:Landroid/support/v7/widget/ar;

    if-eqz v0, :cond_1

    iget-object v0, p0, Landroid/support/v7/widget/ay;->b:Landroid/support/v7/widget/ar;

    iget-object v1, p0, Landroid/support/v7/widget/ay;->a:Landroid/widget/ImageView;
    ...
    :cond_1
    iget-object v0, p0, Landroid/support/v7/widget/ay;->a:Landroid/widget/ImageView;
...
.method public a(Landroid/util/AttributeSet;I)V
    ...
    invoke-virtual {v1, v0}, Landroid/support/v7/widget/ga;->b(I)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    if-eqz v0, :cond_0

    iget-object v2, p0, Landroid/support/v7/widget/ay;->a:Landroid/widget/ImageView;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/ay;->b:Landroid/support/v7/widget/ar;

    iget-object v3, p0, Landroid/support/v7/widget/ay;->a:Landroid/widget/ImageView;
    ...
    :cond_2
    invoke-virtual {v1}, Landroid/support/v7/widget/ga;->a()V
