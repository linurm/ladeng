...
.method constructor <init>(Landroid/widget/SeekBar;Landroid/support/v7/widget/ar;)V
    ...
    invoke-direct {p0, p1, p2}, Landroid/support/v7/widget/bd;-><init>(Landroid/widget/ProgressBar;Landroid/support/v7/widget/ar;)V

    iput-object p1, p0, Landroid/support/v7/widget/bh;->c:Landroid/widget/SeekBar;
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/bh;->c:Landroid/widget/SeekBar;

    invoke-virtual {v0}, Landroid/widget/SeekBar;->getContext()Landroid/content/Context;

    move-result-object v0

    sget-object v1, Landroid/support/v7/widget/bh;->b:[I
    ...
    invoke-virtual {v0, v2}, Landroid/support/v7/widget/ga;->b(I)Landroid/graphics/drawable/Drawable;

    move-result-object v1

    if-eqz v1, :cond_0

    iget-object v2, p0, Landroid/support/v7/widget/bh;->c:Landroid/widget/SeekBar;
