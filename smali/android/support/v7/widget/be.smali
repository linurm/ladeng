...
# interfaces
.implements Landroid/support/v4/widget/cl;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/be;->a:Landroid/support/v7/widget/ar;

    new-instance v0, Landroid/support/v7/widget/aq;

    iget-object v1, p0, Landroid/support/v7/widget/be;->a:Landroid/support/v7/widget/ar;

    invoke-direct {v0, p0, v1}, Landroid/support/v7/widget/aq;-><init>(Landroid/widget/CompoundButton;Landroid/support/v7/widget/ar;)V

    iput-object v0, p0, Landroid/support/v7/widget/be;->b:Landroid/support/v7/widget/aq;

    iget-object v0, p0, Landroid/support/v7/widget/be;->b:Landroid/support/v7/widget/aq;
...
.method public getCompoundPaddingLeft()I
    ...
    iget-object v1, p0, Landroid/support/v7/widget/be;->b:Landroid/support/v7/widget/aq;
...
.method public setButtonDrawable(I)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/be;->a:Landroid/support/v7/widget/ar;
    ...
    :goto_0
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/be;->setButtonDrawable(Landroid/graphics/drawable/Drawable;)V
