...
.field private E:Landroid/support/v7/widget/gg;

.field private final F:Landroid/support/v7/widget/y;

.field private G:Landroid/support/v7/widget/gi;

.field private H:Landroid/support/v7/widget/k;

.field private I:Landroid/support/v7/widget/ge;
...
.field private final t:Landroid/support/v7/widget/fa;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/Toolbar;->t:Landroid/support/v7/widget/fa;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/Toolbar;->F:Landroid/support/v7/widget/y;
    ...
    invoke-virtual {v0, v1, v7}, Landroid/support/v7/widget/ga;->g(II)I
    ...
    invoke-virtual {v0, v1, v2}, Landroid/support/v7/widget/ga;->c(II)I
    ...
    invoke-virtual {v0, v1, v7}, Landroid/support/v7/widget/ga;->d(II)I
    ...
    invoke-virtual {v0, v1, v6}, Landroid/support/v7/widget/ga;->d(II)I
    ...
    invoke-virtual {v0, v1, v6}, Landroid/support/v7/widget/ga;->e(II)I
    ...
    invoke-virtual {v0, v1, v8}, Landroid/support/v7/widget/ga;->d(II)I

    move-result v1

    sget v2, Landroid/support/v7/b/l;->Toolbar_contentInsetEnd:I

    invoke-virtual {v0, v2, v8}, Landroid/support/v7/widget/ga;->d(II)I

    move-result v2

    sget v3, Landroid/support/v7/b/l;->Toolbar_contentInsetLeft:I

    invoke-virtual {v0, v3, v7}, Landroid/support/v7/widget/ga;->e(II)I

    move-result v3

    sget v4, Landroid/support/v7/b/l;->Toolbar_contentInsetRight:I

    invoke-virtual {v0, v4, v7}, Landroid/support/v7/widget/ga;->e(II)I

    move-result v4

    iget-object v5, p0, Landroid/support/v7/widget/Toolbar;->t:Landroid/support/v7/widget/fa;

    invoke-virtual {v5, v3, v4}, Landroid/support/v7/widget/fa;->b(II)V
    ...
    :cond_4
    iget-object v3, p0, Landroid/support/v7/widget/Toolbar;->t:Landroid/support/v7/widget/fa;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/ga;->c(I)Ljava/lang/CharSequence;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/ga;->f(I)Z
    ...
    invoke-virtual {v0, v1, v6}, Landroid/support/v7/widget/ga;->b(II)I
    ...
    iput-object v0, p0, Landroid/support/v7/widget/Toolbar;->N:Landroid/support/v7/widget/ar;
...
.method private a(Landroid/view/View;I)I
    ...
    :goto_0
    iget v4, v0, Landroid/support/v7/widget/gf;->a:I
...
.method private a(Ljava/util/List;[I)I
    ...
    iget v8, v1, Landroid/support/v7/widget/gf;->leftMargin:I

    sub-int v6, v8, v6

    iget v1, v1, Landroid/support/v7/widget/gf;->rightMargin:I
...
.method static synthetic a(Landroid/support/v7/widget/Toolbar;)Landroid/support/v7/widget/gg;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->E:Landroid/support/v7/widget/gg;
...
.method private a(Landroid/view/View;Z)V
    ...
    invoke-virtual {p0}, Landroid/support/v7/widget/Toolbar;->i()Landroid/support/v7/widget/gf;
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/Toolbar;->a(Landroid/view/ViewGroup$LayoutParams;)Landroid/support/v7/widget/gf;
...
.method private m()V
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/ActionMenuView;->d()Landroid/support/v7/view/menu/i;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/Toolbar;->I:Landroid/support/v7/widget/ge;
    ...
    invoke-direct {v1, p0, v2}, Landroid/support/v7/widget/ge;-><init>(Landroid/support/v7/widget/Toolbar;Landroid/support/v7/widget/gb;)V

    iput-object v1, p0, Landroid/support/v7/widget/Toolbar;->I:Landroid/support/v7/widget/ge;
    ...
    invoke-virtual {v0, v1, v2}, Landroid/support/v7/view/menu/i;->a(Landroid/support/v7/view/menu/x;Landroid/content/Context;)V
...
.method private n()V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/Toolbar;->F:Landroid/support/v7/widget/y;

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/ActionMenuView;->setOnMenuItemClickListener(Landroid/support/v7/widget/y;)V

    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->b:Landroid/support/v7/widget/ActionMenuView;

    iget-object v1, p0, Landroid/support/v7/widget/Toolbar;->J:Landroid/support/v7/view/menu/y;

    iget-object v2, p0, Landroid/support/v7/widget/Toolbar;->K:Landroid/support/v7/view/menu/j;

    invoke-virtual {v0, v1, v2}, Landroid/support/v7/widget/ActionMenuView;->a(Landroid/support/v7/view/menu/y;Landroid/support/v7/view/menu/j;)V
...
# virtual methods
.method public a(Landroid/util/AttributeSet;)Landroid/support/v7/widget/gf;
    .locals 2
...
.method protected a(Landroid/view/ViewGroup$LayoutParams;)Landroid/support/v7/widget/gf;
    .locals 1
    ...
    check-cast p1, Landroid/support/v7/widget/gf;

    invoke-direct {v0, p1}, Landroid/support/v7/widget/gf;-><init>(Landroid/support/v7/widget/gf;)V
    ...
    invoke-direct {v0, p1}, Landroid/support/v7/widget/gf;-><init>(Landroid/support/v7/a/b;)V
    ...
    invoke-direct {v0, p1}, Landroid/support/v7/widget/gf;-><init>(Landroid/view/ViewGroup$MarginLayoutParams;)V
    ...
    invoke-direct {v0, p1}, Landroid/support/v7/widget/gf;-><init>(Landroid/view/ViewGroup$LayoutParams;)V
...
.method public a(II)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->t:Landroid/support/v7/widget/fa;

    invoke-virtual {v0, p1, p2}, Landroid/support/v7/widget/fa;->a(II)V
...
.method public a(Landroid/support/v7/view/menu/i;Landroid/support/v7/widget/k;)V
    .locals 4
    ...
    iget-object v1, p0, Landroid/support/v7/widget/Toolbar;->H:Landroid/support/v7/widget/k;
    ...
    :cond_2
    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->I:Landroid/support/v7/widget/ge;

    if-nez v0, :cond_3

    new-instance v0, Landroid/support/v7/widget/ge;

    invoke-direct {v0, p0, v3}, Landroid/support/v7/widget/ge;-><init>(Landroid/support/v7/widget/Toolbar;Landroid/support/v7/widget/gb;)V

    iput-object v0, p0, Landroid/support/v7/widget/Toolbar;->I:Landroid/support/v7/widget/ge;

    :cond_3
    invoke-virtual {p2, v2}, Landroid/support/v7/widget/k;->d(Z)V

    if-eqz p1, :cond_4

    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->j:Landroid/content/Context;

    invoke-virtual {p1, p2, v0}, Landroid/support/v7/view/menu/i;->a(Landroid/support/v7/view/menu/x;Landroid/content/Context;)V

    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->I:Landroid/support/v7/widget/ge;

    iget-object v1, p0, Landroid/support/v7/widget/Toolbar;->j:Landroid/content/Context;

    invoke-virtual {p1, v0, v1}, Landroid/support/v7/view/menu/i;->a(Landroid/support/v7/view/menu/x;Landroid/content/Context;)V
    ...
    invoke-virtual {v0, p2}, Landroid/support/v7/widget/ActionMenuView;->setPresenter(Landroid/support/v7/widget/k;)V

    iput-object p2, p0, Landroid/support/v7/widget/Toolbar;->H:Landroid/support/v7/widget/k;
    ...
    invoke-virtual {p2, v0, v3}, Landroid/support/v7/widget/k;->a(Landroid/content/Context;Landroid/support/v7/view/menu/i;)V

    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->I:Landroid/support/v7/widget/ge;

    iget-object v1, p0, Landroid/support/v7/widget/Toolbar;->j:Landroid/content/Context;

    invoke-virtual {v0, v1, v3}, Landroid/support/v7/widget/ge;->a(Landroid/content/Context;Landroid/support/v7/view/menu/i;)V

    invoke-virtual {p2, v2}, Landroid/support/v7/widget/k;->b(Z)V

    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->I:Landroid/support/v7/widget/ge;

    invoke-virtual {v0, v2}, Landroid/support/v7/widget/ge;->b(Z)V
...
.method public a(Landroid/support/v7/view/menu/y;Landroid/support/v7/view/menu/j;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/Toolbar;->J:Landroid/support/v7/view/menu/y;

    iput-object p2, p0, Landroid/support/v7/widget/Toolbar;->K:Landroid/support/v7/view/menu/j;
    ...
    invoke-virtual {v0, p1, p2}, Landroid/support/v7/widget/ActionMenuView;->a(Landroid/support/v7/view/menu/y;Landroid/support/v7/view/menu/j;)V
...
.method public g()Z
    ...
    iget-object v0, v0, Landroid/support/v7/widget/ge;->b:Landroid/support/v7/view/menu/m;
...
.method public synthetic generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/Toolbar;->a(Landroid/util/AttributeSet;)Landroid/support/v7/widget/gf;
...
.method protected synthetic generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/Toolbar;->a(Landroid/view/ViewGroup$LayoutParams;)Landroid/support/v7/widget/gf;
...
.method public getContentInsetEnd()I
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/fa;->d()I
...
.method public getContentInsetLeft()I
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/fa;->a()I
...
.method public getContentInsetRight()I
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/fa;->b()I
...
.method public getContentInsetStart()I
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/fa;->c()I
...
.method public getWrapper()Landroid/support/v7/widget/bx;
    .locals 2

    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->G:Landroid/support/v7/widget/gi;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/Toolbar;->G:Landroid/support/v7/widget/gi;
...
.method public h()V
    ...
    invoke-virtual {v0}, Landroid/support/v7/view/menu/m;->collapseActionView()Z
...
.method protected i()Landroid/support/v7/widget/gf;
    .locals 2
    ...
    invoke-direct {v0, v1, v1}, Landroid/support/v7/widget/gf;-><init>(II)V
...
.method protected onLayout(ZIIII)V
    ...
    invoke-static/range {p0 .. p0}, Landroid/support/v4/view/bw;->q(Landroid/view/View;)I
    ...
    iget v9, v3, Landroid/support/v7/widget/gf;->topMargin:I
    ...
    check-cast v4, Landroid/support/v7/widget/gf;
    ...
    iget v0, v3, Landroid/support/v7/widget/gf;->topMargin:I
    ...
    iget v3, v3, Landroid/support/v7/widget/gf;->topMargin:I
    ...
    iget v5, v3, Landroid/support/v7/widget/gf;->topMargin:I
    ...
    iget v4, v4, Landroid/support/v7/widget/gf;->bottomMargin:I
    ...
    iget v10, v3, Landroid/support/v7/widget/gf;->topMargin:I
...
.method protected onMeasure(II)V
    ...
    invoke-static {v1}, Landroid/support/v4/view/bw;->k(Landroid/view/View;)I

    move-result v1

    invoke-static {v9, v1}, Landroid/support/v7/widget/gp;->a(II)I
    ...
    invoke-static {v0}, Landroid/support/v4/view/bw;->k(Landroid/view/View;)I

    move-result v0

    invoke-static {v9, v0}, Landroid/support/v7/widget/gp;->a(II)I
    ...
    invoke-static {v11, v0}, Landroid/support/v7/widget/gp;->a(II)I
    ...
    invoke-static {v11, v4}, Landroid/support/v7/widget/gp;->a(II)I
    ...
    invoke-static {v2}, Landroid/support/v4/view/bw;->k(Landroid/view/View;)I

    move-result v2

    invoke-static {v11, v2}, Landroid/support/v7/widget/gp;->a(II)I
    ...
    invoke-static {v1, p1, v2}, Landroid/support/v4/view/bw;->a(III)I
    ...
    invoke-static {v0, p2, v2}, Landroid/support/v4/view/bw;->a(III)I
...
.method public onRtlPropertiesChanged(I)V
    ...
    :cond_0
    iget-object v1, p0, Landroid/support/v7/widget/Toolbar;->t:Landroid/support/v7/widget/fa;

    if-ne p1, v0, :cond_1

    :goto_0
    invoke-virtual {v1, v0}, Landroid/support/v7/widget/fa;->a(Z)V
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    iget-object v1, v1, Landroid/support/v7/widget/ge;->b:Landroid/support/v7/view/menu/m;
    ...
    invoke-virtual {v1}, Landroid/support/v7/view/menu/m;->getItemId()I
...
.method public setLogo(I)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->N:Landroid/support/v7/widget/ar;
...
.method public setOnMenuItemClickListener(Landroid/support/v7/widget/gg;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/Toolbar;->E:Landroid/support/v7/widget/gg;
