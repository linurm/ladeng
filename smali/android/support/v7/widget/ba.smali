...
.field private d:Landroid/support/v7/widget/bp;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/widget/ba;->a:[I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ba;->b:Landroid/support/v7/widget/ar;

    invoke-virtual {p0}, Landroid/support/v7/widget/ba;->getContext()Landroid/content/Context;

    move-result-object v0

    sget-object v1, Landroid/support/v7/widget/ba;->a:[I
    ...
    invoke-virtual {p0, v1}, Landroid/support/v7/widget/ba;->setDropDownBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ba;->b:Landroid/support/v7/widget/ar;

    invoke-direct {v0, p0, v1}, Landroid/support/v7/widget/am;-><init>(Landroid/view/View;Landroid/support/v7/widget/ar;)V

    iput-object v0, p0, Landroid/support/v7/widget/ba;->c:Landroid/support/v7/widget/am;

    iget-object v0, p0, Landroid/support/v7/widget/ba;->c:Landroid/support/v7/widget/am;

    invoke-virtual {v0, p2, p3}, Landroid/support/v7/widget/am;->a(Landroid/util/AttributeSet;I)V

    invoke-static {p0}, Landroid/support/v7/widget/bp;->a(Landroid/widget/TextView;)Landroid/support/v7/widget/bp;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/widget/ba;->d:Landroid/support/v7/widget/bp;

    iget-object v0, p0, Landroid/support/v7/widget/ba;->d:Landroid/support/v7/widget/bp;

    invoke-virtual {v0, p2, p3}, Landroid/support/v7/widget/bp;->a(Landroid/util/AttributeSet;I)V
...
.method public setDropDownBackgroundResource(I)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ba;->b:Landroid/support/v7/widget/ar;
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/ba;->setDropDownBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
...
.method public setTextAppearance(Landroid/content/Context;I)V
    ...
    invoke-virtual {v0, p1, p2}, Landroid/support/v7/widget/bp;->a(Landroid/content/Context;I)V
