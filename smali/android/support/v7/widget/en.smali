...
.method private b(I)Ljava/util/ArrayList;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/en;->a:Landroid/util/SparseArray;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/en;->a:Landroid/util/SparseArray;

    invoke-virtual {v1, p1, v0}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    iget-object v1, p0, Landroid/support/v7/widget/en;->b:Landroid/util/SparseIntArray;
...
.method a(Landroid/support/v7/widget/dx;)V
    .locals 1
...
.method a(Landroid/support/v7/widget/dx;Landroid/support/v7/widget/dx;Z)V
    ...
    invoke-virtual {p0, p2}, Landroid/support/v7/widget/en;->a(Landroid/support/v7/widget/dx;)V
...
.method public a(Landroid/support/v7/widget/ex;)V
    ...
    invoke-direct {p0, v0}, Landroid/support/v7/widget/en;->b(I)Ljava/util/ArrayList;

    move-result-object v1

    iget-object v2, p0, Landroid/support/v7/widget/en;->b:Landroid/util/SparseIntArray;
    ...
    :cond_0
    invoke-virtual {p1}, Landroid/support/v7/widget/ex;->v()V
