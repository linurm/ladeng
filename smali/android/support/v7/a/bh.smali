...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/a/bh;->a:[Ljava/lang/Class;
    ...
    sput-object v0, Landroid/support/v7/a/bh;->b:[I
    ...
    sput-object v0, Landroid/support/v7/a/bh;->c:[Ljava/lang/String;

    new-instance v0, Landroid/support/v4/g/a;

    invoke-direct {v0}, Landroid/support/v4/g/a;-><init>()V

    sput-object v0, Landroid/support/v7/a/bh;->d:Ljava/util/Map;
...
.method constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/v7/a/bh;->e:[Ljava/lang/Object;
...
.method private static a(Landroid/content/Context;Landroid/util/AttributeSet;ZZ)Landroid/content/Context;
    ...
    invoke-virtual {v0}, Landroid/support/v7/view/e;->a()I
...
.method private a(Landroid/content/Context;Ljava/lang/String;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    :cond_0
    :try_start_0
    iget-object v0, p0, Landroid/support/v7/a/bh;->e:[Ljava/lang/Object;
    ...
    :goto_0
    sget-object v0, Landroid/support/v7/a/bh;->c:[Ljava/lang/String;
    ...
    invoke-direct {p0, p1, p2, v0}, Landroid/support/v7/a/bh;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    :try_end_0
    ...
    iget-object v2, p0, Landroid/support/v7/a/bh;->e:[Ljava/lang/Object;
...
.method private a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    ...
    sget-object v0, Landroid/support/v7/a/bh;->d:Ljava/util/Map;
    ...
    sget-object v1, Landroid/support/v7/a/bh;->a:[Ljava/lang/Class;

    invoke-virtual {v0, v1}, Ljava/lang/Class;->getConstructor([Ljava/lang/Class;)Ljava/lang/reflect/Constructor;

    move-result-object v0

    sget-object v1, Landroid/support/v7/a/bh;->d:Ljava/util/Map;
    ...
    iget-object v1, p0, Landroid/support/v7/a/bh;->e:[Ljava/lang/Object;
...
.method private a(Landroid/view/View;Landroid/util/AttributeSet;)V
    ...
    invoke-static {p1}, Landroid/support/v4/view/bw;->H(Landroid/view/View;)Z
    ...
    :cond_1
    sget-object v1, Landroid/support/v7/a/bh;->b:[I
    ...
    new-instance v2, Landroid/support/v7/a/bi;

    invoke-direct {v2, p1, v1}, Landroid/support/v7/a/bi;-><init>(Landroid/view/View;Ljava/lang/String;)V
...
.method public final a(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;ZZZZ)Landroid/view/View;
    ...
    :cond_0
    invoke-static {v0, p4, p6, p7}, Landroid/support/v7/a/bh;->a(Landroid/content/Context;Landroid/util/AttributeSet;ZZ)Landroid/content/Context;
    ...
    invoke-direct {p0, v0, p2, p4}, Landroid/support/v7/a/bh;->a(Landroid/content/Context;Ljava/lang/String;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    invoke-direct {p0, v0, p4}, Landroid/support/v7/a/bh;->a(Landroid/view/View;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v1, v0, p4}, Landroid/support/v7/widget/br;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v1, v0, p4}, Landroid/support/v7/widget/bi;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v1, v0, p4}, Landroid/support/v7/widget/ao;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v1, v0, p4}, Landroid/support/v7/widget/ap;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v1, v0, p4}, Landroid/support/v7/widget/bf;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
