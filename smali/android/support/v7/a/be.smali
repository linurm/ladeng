...
.method constructor <init>(I)V
    ...
    iput p1, p0, Landroid/support/v7/a/be;->a:I

    const/4 v0, 0x0

    iput-boolean v0, p0, Landroid/support/v7/a/be;->q:Z
...
.method a(Landroid/support/v7/view/menu/y;)Landroid/support/v7/view/menu/z;
    ...
    iget-object v0, p0, Landroid/support/v7/a/be;->j:Landroid/support/v7/view/menu/i;
    ...
    :cond_0
    iget-object v0, p0, Landroid/support/v7/a/be;->k:Landroid/support/v7/view/menu/g;

    if-nez v0, :cond_1

    new-instance v0, Landroid/support/v7/view/menu/g;

    iget-object v1, p0, Landroid/support/v7/a/be;->l:Landroid/content/Context;
    ...
    iput-object v0, p0, Landroid/support/v7/a/be;->k:Landroid/support/v7/view/menu/g;
    ...
    iget-object v1, p0, Landroid/support/v7/a/be;->k:Landroid/support/v7/view/menu/g;
    ...
    iget-object v1, p0, Landroid/support/v7/a/be;->g:Landroid/view/ViewGroup;
...
.method a(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Landroid/support/v7/a/be;->l:Landroid/content/Context;
    ...
    iput v1, p0, Landroid/support/v7/a/be;->b:I
    ...
    iput v1, p0, Landroid/support/v7/a/be;->f:I
...
.method a(Landroid/support/v7/view/menu/i;)V
    ...
    :cond_2
    iput-object p1, p0, Landroid/support/v7/a/be;->j:Landroid/support/v7/view/menu/i;
...
.method public a()Z
    ...
    iget-object v2, p0, Landroid/support/v7/a/be;->h:Landroid/view/View;
    ...
    :cond_1
    iget-object v2, p0, Landroid/support/v7/a/be;->i:Landroid/view/View;

    if-nez v2, :cond_0

    iget-object v2, p0, Landroid/support/v7/a/be;->k:Landroid/support/v7/view/menu/g;
