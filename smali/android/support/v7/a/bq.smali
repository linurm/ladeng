.class Landroid/support/v7/a/bq;
.super Ljava/lang/Object;


# static fields
.field private static d:Landroid/support/v7/a/bq;
...
.method static a()Landroid/support/v7/a/bq;
    .locals 1

    sget-object v0, Landroid/support/v7/a/bq;->d:Landroid/support/v7/a/bq;

    if-nez v0, :cond_0

    new-instance v0, Landroid/support/v7/a/bq;

    invoke-direct {v0}, Landroid/support/v7/a/bq;-><init>()V

    sput-object v0, Landroid/support/v7/a/bq;->d:Landroid/support/v7/a/bq;
...
.method public a(JDD)V
    ...
    iput v2, p0, Landroid/support/v7/a/bq;->c:I

    const-wide/16 v2, -0x1

    iput-wide v2, p0, Landroid/support/v7/a/bq;->a:J

    const-wide/16 v2, -0x1

    iput-wide v2, p0, Landroid/support/v7/a/bq;->b:J
    ...
    iput-wide v6, p0, Landroid/support/v7/a/bq;->a:J
    ...
    iget-wide v2, p0, Landroid/support/v7/a/bq;->b:J

    cmp-long v2, v2, p1

    if-gez v2, :cond_2

    iget-wide v2, p0, Landroid/support/v7/a/bq;->a:J
